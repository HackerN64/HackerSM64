...
typedef enum PACKED REGIDS_RDRAM { // RDRAM_BASE_REG
...
typedef enum PACKED REGIDS_SP { // SP_BASE_REG
...
typedef enum PACKED REGIDS_DPC { // DPC_BASE_REG
...
typedef enum PACKED REGIDS_DPS { // DPS_BASE_REG
...
typedef enum PACKED REGIDS_MI { // MI_BASE_REG
...
typedef enum PACKED REGIDS_VI { // VI_BASE_REG
...
typedef enum PACKED REGIDS_AI { // AI_BASE_REG
...
typedef enum PACKED REGIDS_PI { // PI_BASE_REG
...
typedef enum PACKED REGIDS_RI { // RI_BASE_REG
...
typedef enum PACKED REGIDS_SI { // SI_BASE_REG
...
typedef enum PACKED REGIDS_GIO { // GIO_BASE_REG
...
typedef enum PACKED REGIDS_RDB { // RDB_BASE_REG
...
typedef enum PACKED REGIDS_GIO_RDB { // GIO_RDB_BASE_REG
