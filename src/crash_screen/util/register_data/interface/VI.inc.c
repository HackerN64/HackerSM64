...
static const char* sRegDesc_VI[] = {
    ...
    [REGID_VI_TEST_ADDR  ] = "Test address",
    [REGID_VI_STAGED_DATA] = "Staged data",
};
ALIGNED32 static const RegisterInfo sRegInfo_VI[] = {
    ...
    [REGID_VI_TEST_ADDR  ] = DEF_IREG(VI_TEST_ADDR_REG,   "TEST_ADDR",              REGID_VI_TEST_ADDR  ),
    [REGID_VI_STAGED_DATA] = DEF_IREG(VI_STAGED_DATA_REG, "STAGED_DATA",            REGID_VI_STAGED_DATA),
};
