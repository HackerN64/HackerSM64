...
ALIGNED32 static const RegisterInfo sRegInfo_CP0[CP0_NUM_REGISTERS] = {
    ...
    [REG_CP0_ENTRYLO0 ] = DEF_CP0_SREG(C0_ENTRYLO0,  u64,           "EntryLo0", "L0", FALSE, REG_DESC_CP0_ENTRYLO0 ),
    [REG_CP0_ENTRYLO1 ] = DEF_CP0_SREG(C0_ENTRYLO1,  u64,           "EntryLo1", "L1", FALSE, REG_DESC_CP0_ENTRYLO1 ),
    [REG_CP0_CONTEXT  ] = DEF_CP0_SREG(C0_CONTEXT,   u64,           "Context",  "CX", FALSE, REG_DESC_CP0_CONTEXT  ),
    [REG_CP0_PAGEMASK ] = DEF_CP0_SREG(C0_PAGEMASK,  u32,           "PageMask", "PM", FALSE, REG_DESC_CP0_PAGEMASK ),
    [REG_CP0_WIRED    ] = DEF_CP0_SREG(C0_WIRED,     u32,           "Wired",    "WR", FALSE, REG_DESC_CP0_WIRED    ),
    [REG_CP0_7        ] = DEF_CP0_SREG(7,            int,           "07",       "07", FALSE, REG_DESC_CP0_RESERVED ),
    [REG_CP0_BADVADDR ] = DEF_CP0_TREG(C0_BADVADDR,  u64, badvaddr, "BadVAddr", "VA", FALSE, REG_DESC_CP0_BADVADDR ),
    [REG_CP0_COUNT    ] = DEF_CP0_SREG(C0_COUNT,     u32,           "Count",    "CT", FALSE, REG_DESC_CP0_COUNT    ),
    [REG_CP0_ENTRYHI  ] = DEF_CP0_SREG(C0_ENTRYHI,   u64,           "EntryHi",  "EH", FALSE, REG_DESC_CP0_ENTRYHI  ),
    [REG_CP0_COMPARE  ] = DEF_CP0_SREG(C0_COMPARE,   u32,           "Compare",  "CP", FALSE, REG_DESC_CP0_COMPARE  ),
    [REG_CP0_SR       ] = DEF_CP0_TREG(C0_SR,        u32, sr,       "Status",   "SR", FALSE, REG_DESC_CP0_SR       ),
    [REG_CP0_CAUSE    ] = DEF_CP0_TREG(C0_CAUSE,     u32, cause,    "Cause",    "CR", FALSE, REG_DESC_CP0_CAUSE    ),
    [REG_CP0_EPC      ] = DEF_CP0_TREG(C0_EPC,       u64, pc,       "EPC",      "PC", TRUE,  REG_DESC_CP0_EPC      ),
    [REG_CP0_PRID     ] = DEF_CP0_SREG(C0_PRID,      u32,           "PRId",     "PR", FALSE, REG_DESC_CP0_PRID     ),
    [REG_CP0_CONFIG   ] = DEF_CP0_SREG(C0_CONFIG,    u32,           "Config",   "CF", FALSE, REG_DESC_CP0_CONFIG   ),
    [REG_CP0_LLADDR   ] = DEF_CP0_SREG(C0_LLADDR,    u32,           "LLAddr",   "LL", TRUE,  REG_DESC_CP0_LLADDR   ),
    [REG_CP0_WATCHLO  ] = DEF_CP0_SREG(C0_WATCHLO,   u32,           "WatchLo",  "WL", FALSE, REG_DESC_CP0_WATCHLO  ),
    [REG_CP0_WATCHHI  ] = DEF_CP0_SREG(C0_WATCHHI,   u32,           "WatchHi",  "WH", FALSE, REG_DESC_CP0_WATCHHI  ),
    [REG_CP0_XCONTEXT ] = DEF_CP0_SREG(20,           u64,           "XContext", "XX", FALSE, REG_DESC_CP0_XCONTEXT ),
    [REG_CP0_21       ] = DEF_CP0_SREG(21,           int,           "21",       "21", FALSE, REG_DESC_CP0_RESERVED ),
    [REG_CP0_22       ] = DEF_CP0_SREG(22,           int,           "22",       "22", FALSE, REG_DESC_CP0_RESERVED ),
    [REG_CP0_23       ] = DEF_CP0_SREG(23,           int,           "23",       "23", FALSE, REG_DESC_CP0_RESERVED ),
    [REG_CP0_24       ] = DEF_CP0_SREG(24,           int,           "24",       "24", FALSE, REG_DESC_CP0_RESERVED ),
    [REG_CP0_25       ] = DEF_CP0_SREG(25,           int,           "25",       "25", FALSE, REG_DESC_CP0_RESERVED ),
    [REG_CP0_ECC      ] = DEF_CP0_SREG(C0_ECC,       u32,           "PErr",     "PE", FALSE, REG_DESC_CP0_ECC      ),
    [REG_CP0_CACHE_ERR] = DEF_CP0_SREG(C0_CACHE_ERR, u32,           "CacheErr", "CE", FALSE, REG_DESC_CP0_CACHE_ERR), // Unused (always 0)
    [REG_CP0_TAGLO    ] = DEF_CP0_SREG(C0_TAGLO,     u32,           "TagLo",    "TL", FALSE, REG_DESC_CP0_TAGLO    ),
    [REG_CP0_TAGHI    ] = DEF_CP0_SREG(C0_TAGHI,     u32,           "TagHi",    "TH", FALSE, REG_DESC_CP0_TAGHI    ),
    [REG_CP0_ERROR_EPC] = DEF_CP0_SREG(C0_ERROR_EPC, u64,           "ErrorEPC", "EE", TRUE,  REG_DESC_CP0_ERROR_EPC),
    [REG_CP0_31       ] = DEF_CP0_SREG(31,           int,           "31",       "31", FALSE, REG_DESC_CP0_RESERVED ),
};
