...
const char* sRegDesc[] = {
    ...
    [REG_DESC_FP    ] = "saved value or frame pointer", //! TODO: determine which one
...
ALIGNED32 static const RegisterInfo sRegisters_COP1[CP1_NUM_REGISTERS] = {
    [REG_CP1_F00] = DEF_COP1_TREG_EVEN(0,  "00", REG_DESC_SUBRET), [REG_CP1_F02] = DEF_COP1_TREG_EVEN(2,  "02", REG_DESC_SUBRET),
    [REG_CP1_F04] = DEF_COP1_TREG_EVEN(4,  "04", REG_DESC_TEMP  ), [REG_CP1_F06] = DEF_COP1_TREG_EVEN(6,  "06", REG_DESC_TEMP  ), [REG_CP1_F08] = DEF_COP1_TREG_EVEN(8,  "08", REG_DESC_TEMP  ), [REG_CP1_F10] = DEF_COP1_TREG_EVEN(10, "10", REG_DESC_TEMP  ),
    [REG_CP1_F12] = DEF_COP1_TREG_EVEN(12, "12", REG_DESC_SUBARG), [REG_CP1_F14] = DEF_COP1_TREG_EVEN(14, "14", REG_DESC_SUBARG),
    [REG_CP1_F16] = DEF_COP1_TREG_EVEN(16, "16", REG_DESC_TEMP  ), [REG_CP1_F18] = DEF_COP1_TREG_EVEN(18, "18", REG_DESC_TEMP  ),
    [REG_CP1_F20] = DEF_COP1_TREG_EVEN(20, "20", REG_DESC_SAVED ), [REG_CP1_F22] = DEF_COP1_TREG_EVEN(22, "22", REG_DESC_SAVED ), [REG_CP1_F24] = DEF_COP1_TREG_EVEN(24, "24", REG_DESC_SAVED ), [REG_CP1_F26] = DEF_COP1_TREG_EVEN(26, "26", REG_DESC_SAVED ), [REG_CP1_F28] = DEF_COP1_TREG_EVEN(28, "28", REG_DESC_SAVED ), [REG_CP1_F30] = DEF_COP1_TREG_EVEN(30, "30", REG_DESC_SAVED ),
};
...
uint64_t get_cop1_reg_val(enum COP1Registers idx) {
    ...
    switch (idx) {
        ...
        CASE_COP1_REG(REG_CP1_F12, f12); CASE_COP1_REG(REG_CP1_F14, f14);
