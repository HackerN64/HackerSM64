...
void bhv_controllable_platform_init(void) {
    ...
    buttonObj = spawn_object_rel_with_rot(o, MODEL_HMC_METAL_ARROW_PLATFORM, bhvControllablePlatformSub,    0, 51,  204, 0,  0x0000, 0);
    buttonObj->oBehParams2ndByte = 1;
    buttonObj = spawn_object_rel_with_rot(o, MODEL_HMC_METAL_ARROW_PLATFORM, bhvControllablePlatformSub,    0, 51, -204, 0, -0x8000, 0);
    buttonObj->oBehParams2ndByte = 2;
    buttonObj = spawn_object_rel_with_rot(o, MODEL_HMC_METAL_ARROW_PLATFORM, bhvControllablePlatformSub,  204, 51,    0, 0,  0x4000, 0);
