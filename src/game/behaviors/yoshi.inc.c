...
void bhv_yoshi_init(void) {
    ...
    if ((save_file_get_total_star_count((gCurrSaveFileNum - 1), COURSE_NUM_TO_INDEX(COURSE_MIN), COURSE_NUM_TO_INDEX(COURSE_MAX)) < 120) || sYoshiDead) {
...
void bhv_yoshi_loop(void) {
    ...
    cur_obj_random_blink(&o->oYoshiBlinkTimer);
}
