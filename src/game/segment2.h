...
extern struct UnicodeCharLUTEntry *main_hud_utf8_2byte_lut[1];
extern struct UnicodeCharLUTEntry *main_hud_utf8_3byte_lut[3];
extern Gfx dl_hud_img_load_tex_block[];
extern Gfx dl_hud_img_begin[];
extern Gfx dl_hud_img_end[];
extern void *main_font_lut[];
extern struct UnicodeCharLUTEntry *main_font_utf8_2byte_lut[1];
extern struct UnicodeCharLUTEntry *main_font_utf8_3byte_lut[1];
