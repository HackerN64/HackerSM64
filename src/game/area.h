...
#define WARP_TRANSITION_TYPES_MASK  0x1E

#define WARP_TRANSITION_FADE_FROM_COLOR  (WARP_TRANSITION_TYPE_COLOR  | WARP_TRANSITION_FADE_FROM) // 0x00
#define WARP_TRANSITION_FADE_INTO_COLOR  (WARP_TRANSITION_TYPE_COLOR  | WARP_TRANSITION_FADE_INTO) // 0x01
#define WARP_TRANSITION_FADE_FROM_STAR   (WARP_TRANSITION_TYPE_STAR   | WARP_TRANSITION_FADE_FROM) // 0x08
#define WARP_TRANSITION_FADE_INTO_STAR   (WARP_TRANSITION_TYPE_STAR   | WARP_TRANSITION_FADE_INTO) // 0x09
#define WARP_TRANSITION_FADE_FROM_CIRCLE (WARP_TRANSITION_TYPE_CIRCLE | WARP_TRANSITION_FADE_FROM) // 0x0A
#define WARP_TRANSITION_FADE_INTO_CIRCLE (WARP_TRANSITION_TYPE_CIRCLE | WARP_TRANSITION_FADE_INTO) // 0x0B
#define WARP_TRANSITION_FADES_FROM_LARGE (WARP_TRANSITION_TYPES_LARGE | WARP_TRANSITION_FADE_FROM) // 0x0E
#define WARP_TRANSITION_FADES_INTO_LARGE (WARP_TRANSITION_TYPES_LARGE | WARP_TRANSITION_FADE_INTO) // 0x0F
#define WARP_TRANSITION_FADE_FROM_MARIO  (WARP_TRANSITION_TYPE_MARIO  | WARP_TRANSITION_FADE_FROM) // 0x10
#define WARP_TRANSITION_FADE_INTO_MARIO  (WARP_TRANSITION_TYPE_MARIO  | WARP_TRANSITION_FADE_INTO) // 0x11
#define WARP_TRANSITION_FADE_FROM_BOWSER (WARP_TRANSITION_TYPE_BOWSER | WARP_TRANSITION_FADE_FROM) // 0x12
#define WARP_TRANSITION_FADE_INTO_BOWSER (WARP_TRANSITION_TYPE_BOWSER | WARP_TRANSITION_FADE_INTO) // 0x13
