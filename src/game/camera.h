...
extern void cutscene_grand_star_fly_start(struct Camera *c);
extern void cutscene_grand_star_fly_move_to_mario(UNUSED struct Camera *c);
extern void cutscene_grand_star_fly_mario_offscreen(UNUSED struct Camera *c);
extern void cutscene_grand_star_fly_app_cvars(struct Camera *c);
...
extern void cutscene_shake_explosion(UNUSED struct Camera *c);
...
extern void cutscene_bbh_death(struct Camera *c);
...
extern void cam_castle_hmc_start_pool_cutscene(struct Camera *c);
extern void calc_y_to_curr_floor(f32 *posOff, f32 posMul, f32 posBound, f32 *focOff, f32 focMul, f32 focBound);
extern void mode_spiral_stairs_camera(struct Camera *c);
extern void cutscene_exit_to_castle_grounds_end(struct Camera *c);
extern void update_camera_yaw(struct Camera *c);
extern void cutscene_credits_reset_spline(UNUSED struct Camera *c);
...
extern void cutscene_exit_to_castle_grounds_focus_mario(struct Camera *c);
