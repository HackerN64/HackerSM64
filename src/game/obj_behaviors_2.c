...
s32 clamp_s16(s16 *value, s16 minimum, s16 maximum) { // move to math_util?
    if (*value <= minimum) {
        *value = minimum;
        ...
        if (o->oInteractStatus & INT_STATUS_ATTACKED_MARIO) {
            ...
            switch (attackHandlers[attackType - 1]) {
                ...
                case ATTACK_HANDLER_SPECIAL_KOOPA_LOSE_SHELL:
                    return ATTACK_HANDLER_SPECIAL_KOOPA_LOSE_SHELL;
                    break;
                ...
                case ATTACK_HANDLER_SPECIAL_WIGGLER_JUMPED_ON:
                    return ATTACK_HANDLER_SPECIAL_WIGGLER_JUMPED_ON;
                    break;

                case ATTACK_HANDLER_SPECIAL_HUGE_GOOMBA_WEAKLY_ATTACKED:
                    return ATTACK_HANDLER_SPECIAL_HUGE_GOOMBA_WEAKLY_ATTACKED;
                    break;
