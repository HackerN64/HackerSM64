...
void cutscene_non_painting_set_cam_pos(struct Camera *c) {
    ...
    switch (gPrevLevel) {
        case LEVEL_HMC:
            vec3f_set(c->pos, 3465.0f, -1008.0f, -2961.0f);
            break;
        case LEVEL_COTMC:
            vec3f_set(c->pos, 3465.0f, -1008.0f, -2961.0f);
            break;
        case LEVEL_RR:
            vec3f_set(c->pos, -3741.0f, 3151.0f, 6065.0f);
            break;
        case LEVEL_WMOTR:
            vec3f_set(c->pos, 1972.0f, 3230.0f, 5891.0f);
            break;
        default:
