...
void check_stack_validity(void) {
    ...
    assert(gIdleThreadStack[0] == gIdleThreadStack[THREAD1_STACK - 1], "Thread 5 stack overflow.")
    gThread3Stack[0]++;
    gThread3Stack[THREAD3_STACK - 1]++;
    assert(gThread3Stack[0] == gThread3Stack[THREAD3_STACK - 1], "Thread 5 stack overflow.")
    gThread4Stack[0]++;
    gThread4Stack[THREAD4_STACK - 1]++;
    assert(gThread4Stack[0] == gThread4Stack[THREAD4_STACK - 1], "Thread 5 stack overflow.")
    gThread5Stack[0]++;
    ...
    assert(gThread6Stack[0] == gThread6Stack[THREAD6_STACK - 1], "Thread 5 stack overflow.")
#endif
}
#endif
