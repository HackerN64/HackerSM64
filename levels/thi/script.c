...
const LevelScript level_thi_entry[] = {
    INIT_LEVEL(),
    LOAD_YAZ0(        /*seg*/ 0x07, _thi_segment_7SegmentRomStart, _thi_segment_7SegmentRomEnd),
    ...
    LOAD_YAZ0(        /*seg*/ 0x05, _group11_yaz0SegmentRomStart, _group11_yaz0SegmentRomEnd),
