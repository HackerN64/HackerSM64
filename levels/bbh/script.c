...
const LevelScript level_bbh_entry[] = {
    INIT_LEVEL(),
    LOAD_YAZ0(        /*seg*/ 0x07, _bbh_segment_7SegmentRomStart, _bbh_segment_7SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0A, _bbh_skybox_yaz0SegmentRomStart, _bbh_skybox_yaz0SegmentRomEnd),
    LOAD_YAZ0_TEXTURE(/*seg*/ 0x09, _spooky_yaz0SegmentRomStart, _spooky_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x05, _group9_yaz0SegmentRomStart, _group9_yaz0SegmentRomEnd),
