...
const LevelScript level_ddd_entry[] = {
    INIT_LEVEL(),
    LOAD_YAZ0(        /*seg*/ 0x07, _ddd_segment_7SegmentRomStart, _ddd_segment_7SegmentRomEnd),
    ...
    LOAD_YAZ0(        /*seg*/ 0x0A, _water_skybox_yaz0SegmentRomStart, _water_skybox_yaz0SegmentRomEnd),
