...
const LevelScript level_bob_entry[] = {
    INIT_LEVEL(),
    LOAD_YAY0(        /*seg*/ SEGMENT_LEVEL_DATA, _bob_segment_7SegmentRomStart, _bob_segment_7SegmentRomEnd),
    LOAD_YAY0_TEXTURE(/*seg*/ SEGMENT_TEXTURE, _generic_yay0SegmentRomStart, _generic_yay0SegmentRomEnd),
    LOAD_YAY0(        /*seg*/ SEGMENT_SKYBOX, _water_skybox_yay0SegmentRomStart, _water_skybox_yay0SegmentRomEnd),
    LOAD_YAY0(        /*seg*/ SEGMENT_GROUPA_YAY0, _group3_yay0SegmentRomStart, _group3_yay0SegmentRomEnd),
    LOAD_RAW(         /*seg*/ SEGMENT_GROUPA_GEO, _group3_geoSegmentRomStart,  _group3_geoSegmentRomEnd),
    LOAD_YAY0(        /*seg*/ SEGMENT_GROUPB_YAY0, _group14_yay0SegmentRomStart, _group14_yay0SegmentRomEnd),
    LOAD_RAW(         /*seg*/ SEGMENT_GROUPB_GEO, _group14_geoSegmentRomStart,  _group14_geoSegmentRomEnd),
