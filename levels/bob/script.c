...
const LevelScript level_bob_entry[] = {
    INIT_LEVEL(),
    LOAD_YAZ0(        /*seg*/ 0x07, _bob_segment_7SegmentRomStart, _bob_segment_7SegmentRomEnd),
    LOAD_YAZ0_TEXTURE(/*seg*/ 0x09, _generic_yaz0SegmentRomStart, _generic_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0A, _water_skybox_yaz0SegmentRomStart, _water_skybox_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x05, _group3_yaz0SegmentRomStart, _group3_yaz0SegmentRomEnd),
