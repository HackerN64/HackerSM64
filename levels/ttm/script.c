...
const LevelScript level_ttm_entry[] = {
    ...
    AREA(/*index*/ 1, ttm_geo_000A70),
        ...
        OBJECT(/*model*/ MODEL_PAINTING, /*pos*/  3072,   922,  -819, /*angle*/ 0,   90, 0, /*behParam*/ ((PAINTING_ID_TTM_SLIDE << 24) | (0x96 << 16)), /*beh*/ bhvPainting),
        WARP_NODE(/*id*/ 0x96, /*destLevel*/ LEVEL_TTM,    /*destArea*/ 0x02, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_CHECKPOINT),
