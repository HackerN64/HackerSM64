...
const LevelScript level_ttm_entry[] = {
    INIT_LEVEL(),
    LOAD_YAY0(        /*seg*/ SEGMENT_LEVEL_DATA, _ttm_segment_7SegmentRomStart, _ttm_segment_7SegmentRomEnd),
    LOAD_YAY0_TEXTURE(/*seg*/ SEGMENT_TEXTURE, _mountain_yay0SegmentRomStart, _mountain_yay0SegmentRomEnd),
    LOAD_YAY0(        /*seg*/ SEGMENT_SKYBOX, _water_skybox_yay0SegmentRomStart, _water_skybox_yay0SegmentRomEnd),
    LOAD_YAY0(        /*seg*/ SEGMENT_GROUPA_YAY0, _group6_yay0SegmentRomStart, _group6_yay0SegmentRomEnd),
    LOAD_RAW(         /*seg*/ SEGMENT_GROUPA_GEO, _group6_geoSegmentRomStart,  _group6_geoSegmentRomEnd),
