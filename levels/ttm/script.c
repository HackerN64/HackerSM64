...
static const LevelScript script_ttm_area_1_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  -521, -2047,  3568, /*angle*/ 0, 82, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  3476,   708,  -896, /*angle*/ 0, 0, 0,   /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  2461,  1461,  1960, /*angle*/ 0, 125, 0, /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
...
static const LevelScript script_ttm_area_2_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  2972,  3963,  2690, /*angle*/ 0, 45, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/    27,  2145,  -290, /*angle*/ 0, 45, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
...
static const LevelScript script_ttm_area_3_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1471, -3848,  1198, /*angle*/ 0, 0, 0,   /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
...
static const LevelScript script_ttm_area_4_macro_objects[] = {
    // Macro objects
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  2128,  1085, -4800, /*angle*/ 0, 90, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
