...
const LevelScript level_wf_entry[] = {
    INIT_LEVEL(),
    LOAD_YAZ0(        /*seg*/ 0x07, _wf_segment_7SegmentRomStart, _wf_segment_7SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0A, _cloud_floor_skybox_yaz0SegmentRomStart, _cloud_floor_skybox_yaz0SegmentRomEnd),
    LOAD_YAZ0_TEXTURE(/*seg*/ 0x09, _grass_yaz0SegmentRomStart, _grass_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x05, _group1_yaz0SegmentRomStart, _group1_yaz0SegmentRomEnd),
    LOAD_RAW(         /*seg*/ 0x0C, _group1_geoSegmentRomStart,  _group1_geoSegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x06, _group14_yaz0SegmentRomStart, _group14_yaz0SegmentRomEnd),
