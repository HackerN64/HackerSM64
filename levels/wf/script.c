...
static const LevelScript script_wf_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1400,  1160,  3900, /*angle*/ 0, 90, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  1254,  2586,  2299, /*angle*/ 0, 90, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  3396,  1380,  3280, /*angle*/ 0, 0, 0,   /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
