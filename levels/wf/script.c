...
const LevelScript level_wf_entry[] = {
    INIT_LEVEL(),
    LOAD_YAY0(        /*seg*/ SEGMENT_LEVEL_DATA, _wf_segment_7SegmentRomStart, _wf_segment_7SegmentRomEnd),
    ...
    LOAD_YAY0(        /*seg*/ SEGMENT_GROUPA_YAY0, _group1_yay0SegmentRomStart, _group1_yay0SegmentRomEnd),
    LOAD_RAW(         /*seg*/ SEGMENT_GROUPA_GEO, _group1_geoSegmentRomStart,  _group1_geoSegmentRomEnd),
