...
const LevelScript level_bits_entry[] = {
    INIT_LEVEL(),
    LOAD_YAZ0(        /*seg*/ 0x07, _bits_segment_7SegmentRomStart, _bits_segment_7SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0A, _bits_skybox_yaz0SegmentRomStart, _bits_skybox_yaz0SegmentRomEnd),
