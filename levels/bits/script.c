...
const LevelScript level_bits_entry[] = {
    INIT_LEVEL(),
    LOAD_YAY0(        /*seg*/ SEGMENT_LEVEL_DATA, _bits_segment_7SegmentRomStart, _bits_segment_7SegmentRomEnd),
    LOAD_YAY0(        /*seg*/ SEGMENT_SKYBOX, _bits_skybox_yay0SegmentRomStart, _bits_skybox_yay0SegmentRomEnd),
