...
static const LevelScript script_lll_area_1_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  6300,   755, -6580, /*angle*/ 0, 45, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
...
static const LevelScript script_lll_area_2_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/   182,  2623, -2529, /*angle*/ 0, 90, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
