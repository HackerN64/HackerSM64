...
static const LevelScript script_func_local_2[] = {
    ...
    OBJECT(/*model*/ MODEL_LLL_ROTATING_BLOCK_FIRE_BARS,       /*pos*/ -5119,  307, -4095, /*angle*/ 0,  0, 0, /*behParam*/ 0x00040000, /*beh*/ bhvLllRotatingBlockWithFireBars),
...
const LevelScript level_lll_entry[] = {
    INIT_LEVEL(),
    LOAD_YAY0(        /*seg*/ SEGMENT_LEVEL_DATA, _lll_segment_7SegmentRomStart, _lll_segment_7SegmentRomEnd),
    ...
    LOAD_YAY0(        /*seg*/ SEGMENT_GROUPA_YAY0, _group2_yay0SegmentRomStart, _group2_yay0SegmentRomEnd),
    LOAD_RAW(         /*seg*/ SEGMENT_GROUPA_GEO, _group2_geoSegmentRomStart,  _group2_geoSegmentRomEnd),
