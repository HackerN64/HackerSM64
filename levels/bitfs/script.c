...
const LevelScript level_bitfs_entry[] = {
    INIT_LEVEL(),
    LOAD_YAZ0(        /*seg*/ 0x07, _bitfs_segment_7SegmentRomStart, _bitfs_segment_7SegmentRomEnd),
    LOAD_YAZ0_TEXTURE(/*seg*/ 0x09, _sky_yaz0SegmentRomStart, _sky_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0A, _bitfs_skybox_yaz0SegmentRomStart, _bitfs_skybox_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0B, _effect_yaz0SegmentRomStart, _effect_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x05, _group2_yaz0SegmentRomStart, _group2_yaz0SegmentRomEnd),
    LOAD_RAW(         /*seg*/ 0x0C, _group2_geoSegmentRomStart, _group2_geoSegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x06, _group17_yaz0SegmentRomStart, _group17_yaz0SegmentRomEnd),
