...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT(/*model*/ MODEL_BITFS_MOVING_SQUARE_PLATFORM,  /*pos*/ -3890,   102,  617, /*angle*/ 0,  90, 0, /*behParam*/ BP(SLIDING_PLATFORM_BP1_BITFS_MOVING_SQUARE,    0x0C, 0x00, 0x00), /*beh*/ bhvSlidingPlatform2),
    OBJECT(/*model*/ MODEL_BITFS_MOVING_SQUARE_PLATFORM,  /*pos*/ -3276,   102,    2, /*angle*/ 0, 270, 0, /*behParam*/ BP(SLIDING_PLATFORM_BP1_BITFS_MOVING_SQUARE,    0x0C, 0x00, 0x00), /*beh*/ bhvSlidingPlatform2),
    OBJECT(/*model*/ MODEL_BITFS_SLIDING_PLATFORM,        /*pos*/  2103,   198,  312, /*angle*/ 0,   0, 0, /*behParam*/ BP(SLIDING_PLATFORM_BP1_BITFS_SLIDING_PLATFORM, 0x1F, 0x00, 0x00), /*beh*/ bhvSlidingPlatform2),
...
const LevelScript level_bitfs_entry[] = {
    ...
    AREA(/*index*/ 1, bitfs_geo_0007A0),
        ...
        WARP_NODE(/*id*/ WARP_NODE_DEATH, /*destLevel*/ LEVEL_CASTLE,   /*destArea*/ 0x03, /*destNode*/ 0x68, /*flags*/ WARP_NO_CHECKPOINT),
