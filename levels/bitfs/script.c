...
static const LevelScript script_bitfs_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  -640,   800,   180, /*angle*/ 0, 0, 0,   /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -6360,  3760,  -840, /*angle*/ 0, 90, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
