...
static const LevelScript script_bitdw_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -2400,  -800,  1900, /*angle*/ 0, 0, 0,   /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  1660, -1980,  3660, /*angle*/ 0, 90, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
