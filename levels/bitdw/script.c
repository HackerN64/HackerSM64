...
const LevelScript level_bitdw_entry[] = {
    INIT_LEVEL(),
    LOAD_YAZ0(        /*seg*/ 0x07, _bitdw_segment_7SegmentRomStart, _bitdw_segment_7SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0A, _bidw_skybox_yaz0SegmentRomStart, _bidw_skybox_yaz0SegmentRomEnd),
