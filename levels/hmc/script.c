...
const LevelScript level_hmc_entry[] = {
    ...
    AREA(/*index*/ 1, hmc_geo_000B90),
        ...
        WARP_NODE(/*id*/ 0x0A, /*destLevel*/ LEVEL_HMC,    /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0x0B, /*destLevel*/ LEVEL_COTMC,  /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
