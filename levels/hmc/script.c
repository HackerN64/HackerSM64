...
static const LevelScript script_hmc_macro_objects[] = {
    ...
    // Special objects
    OBJECT(/*model*/ MODEL_WOODEN_DOOR, /*pos*/   922, -4689,  2330, /*angle*/ 0, 270, 0, /*behParam*/ (0 << 24), /*beh*/ bhvDoor),
    OBJECT(/*model*/ MODEL_WOODEN_DOOR, /*pos*/ -3586,  1536,   647, /*angle*/ 0,  26, 0, /*behParam*/ (0 << 24), /*beh*/ bhvDoor),
    OBJECT(/*model*/ MODEL_WOODEN_DOOR, /*pos*/  5911,  -204,   870, /*angle*/ 0,   0, 0, /*behParam*/ (0 << 24), /*beh*/ bhvDoor),
    OBJECT(/*model*/ MODEL_WOODEN_DOOR, /*pos*/  3817,   205,   870, /*angle*/ 0,   0, 0, /*behParam*/ (0 << 24), /*beh*/ bhvDoor),
    OBJECT(/*model*/ MODEL_METAL_DOOR,            /*pos*/  1127,  -409, -4709, /*angle*/ 0,  90, 0, /*behParam*/ (0 << 24), /*beh*/ bhvDoor),
    OBJECT(/*model*/ MODEL_METAL_DOOR,            /*pos*/  -468, -4279,  6711, /*angle*/ 0,  45, 0, /*behParam*/ (0 << 24), /*beh*/ bhvDoor),
    OBJECT(/*model*/ MODEL_METAL_DOOR,            /*pos*/  -359, -4279,  6602, /*angle*/ 0, 225, 0, /*behParam*/ (0 << 24), /*beh*/ bhvDoor),
    OBJECT(/*model*/ MODEL_METAL_DOOR,            /*pos*/ -3634,  2355, -2764, /*angle*/ 0,  90, 0, /*behParam*/ (0 << 24), /*beh*/ bhvDoor),
    OBJECT(/*model*/ MODEL_METAL_DOOR,            /*pos*/ -4863,  1843, -7551, /*angle*/ 0, 270, 0, /*behParam*/ (0 << 24), /*beh*/ bhvDoor),
    OBJECT(/*model*/ MODEL_METAL_DOOR,            /*pos*/  3328,  -409, -6911, /*angle*/ 0,   0, 0, /*behParam*/ (0 << 24), /*beh*/ bhvDoor),
