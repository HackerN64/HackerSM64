...
static const LevelScript script_ttc_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_TTC_PUSH_BLOCK, /*pos*/ -1321,  1490, -1563, /*angle*/ 0, 45, 0,  /*behParam*/ 0x00000000, /*beh*/ bhvTTCMovingBar),
    ...
    OBJECT(/*model*/ MODEL_TTC_PUSH_BLOCK, /*pos*/  -517,  3175,  2040, /*angle*/ 0, 180, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTTCMovingBar),
    OBJECT(/*model*/ MODEL_TTC_PUSH_BLOCK, /*pos*/  -170,  1248,  2040, /*angle*/ 0, 180, 0, /*behParam*/ (1 << 16), /*beh*/ bhvTTCMovingBar),
    OBJECT(/*model*/ MODEL_TTC_PUSH_BLOCK, /*pos*/  -515,  1248,  2040, /*angle*/ 0, 180, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTTCMovingBar),
    OBJECT(/*model*/ MODEL_TTC_PUSH_BLOCK, /*pos*/  -175, -1351, -2039, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000, /*beh*/ bhvTTCMovingBar),
    OBJECT(/*model*/ MODEL_TTC_PUSH_BLOCK, /*pos*/  -515, -2590,  2040, /*angle*/ 0, 180, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTTCMovingBar),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1120,  -820,  1320, /*angle*/ 0, 45, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
