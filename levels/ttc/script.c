...
const LevelScript level_ttc_entry[] = {
    INIT_LEVEL(),
    LOAD_YAY0(        /*seg*/ SEGMENT_LEVEL_DATA, _ttc_segment_7SegmentRomStart, _ttc_segment_7SegmentRomEnd),
    LOAD_YAY0_TEXTURE(/*seg*/ SEGMENT_TEXTURE, _machine_yay0SegmentRomStart, _machine_yay0SegmentRomEnd),
