...
const LevelScript level_ttc_entry[] = {
    INIT_LEVEL(),
    LOAD_YAZ0(        /*seg*/ 0x07, _ttc_segment_7SegmentRomStart, _ttc_segment_7SegmentRomEnd),
    LOAD_YAZ0_TEXTURE(/*seg*/ 0x09, _machine_yaz0SegmentRomStart, _machine_yaz0SegmentRomEnd),
