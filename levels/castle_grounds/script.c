...
const LevelScript level_castle_grounds_entry[] = {
    INIT_LEVEL(),
    LOAD_YAY0(        /*seg*/ SEGMENT_LEVEL_DATA, _castle_grounds_segment_7SegmentRomStart, _castle_grounds_segment_7SegmentRomEnd),
    ...
    LOAD_YAY0(        /*seg*/ SEGMENT_GROUPA_YAY0, _group10_yay0SegmentRomStart, _group10_yay0SegmentRomEnd),
    LOAD_RAW(         /*seg*/ SEGMENT_GROUPA_GEO, _group10_geoSegmentRomStart,  _group10_geoSegmentRomEnd),
    LOAD_YAY0(        /*seg*/ SEGMENT_GROUPB_YAY0, _group15_yay0SegmentRomStart, _group15_yay0SegmentRomEnd),
    LOAD_RAW(         /*seg*/ SEGMENT_GROUPB_GEO, _group15_geoSegmentRomStart,  _group15_geoSegmentRomEnd),
