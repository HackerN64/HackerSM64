...
const LevelScript level_castle_grounds_entry[] = {
    INIT_LEVEL(),
    LOAD_YAZ0(        /*seg*/ 0x07, _castle_grounds_segment_7SegmentRomStart, _castle_grounds_segment_7SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0A, _water_skybox_yaz0SegmentRomStart, _water_skybox_yaz0SegmentRomEnd),
    LOAD_YAZ0_TEXTURE(/*seg*/ 0x09, _outside_yaz0SegmentRomStart, _outside_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x05, _group10_yaz0SegmentRomStart, _group10_yaz0SegmentRomEnd),
    LOAD_RAW(         /*seg*/ 0x0C, _group10_geoSegmentRomStart,  _group10_geoSegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x06, _group15_yaz0SegmentRomStart, _group15_yaz0SegmentRomEnd),
