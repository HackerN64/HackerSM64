...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/ -5222,   410,   -154, /*angle*/ 0,  90, 0, /*behParam*/ ((PAINTING_ID_CASTLE_BOB << 24) | (0x96 << 16)), /*beh*/ bhvPainting),
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/ -2611,  -307,  -4352, /*angle*/ 0,   0, 0, /*behParam*/ ((PAINTING_ID_CASTLE_CCM << 24) | (0x97 << 16)), /*beh*/ bhvPainting),
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/   -51,  -205,  -4506, /*angle*/ 0,   0, 0, /*behParam*/ ((PAINTING_ID_CASTLE_WF  << 24) | (0x98 << 16)), /*beh*/ bhvPainting),
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/  4300,   410,   -538, /*angle*/ 0, 270, 0, /*behParam*/ ((PAINTING_ID_CASTLE_JRB << 24) | (0x99 << 16)), /*beh*/ bhvPainting),
    WARP_NODE(/*id*/ 0x96,              /*destLevel*/ LEVEL_BOB,   /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ 0x97,              /*destLevel*/ LEVEL_CCM,   /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ 0x98,              /*destLevel*/ LEVEL_WF,    /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ 0x99,              /*destLevel*/ LEVEL_JRB,   /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  2013,  768, -2014, /*angle*/ 0,    0, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvWarp),
    WARP_NODE(/*id*/ 0x0A,              /*destLevel*/ LEVEL_PSS,   /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -5513,  512, -4324, /*angle*/ 0,    0, 0, /*behParam*/ 0x300B0000, /*beh*/ bhvWarp),
    WARP_NODE(/*id*/ 0x0B,              /*destLevel*/ LEVEL_BITDW, /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  1963,  819,  1280, /*angle*/ 0,    0, 0, /*behParam*/ 0x050C0000, /*beh*/ bhvWarp),
    WARP_NODE(/*id*/ 0x0C,              /*destLevel*/ LEVEL_SA,    /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ WARP_NODE_LOOK_UP, /*destLevel*/ LEVEL_TOTWC, /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
...
static const LevelScript script_func_local_2[] = {
    ...
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/  -967,  1306,   -143, /*angle*/   0,   0, 0, /*behParam*/ ((PAINTING_ID_CASTLE_WDW      << 24) | (0x96 << 16)), /*beh*/ bhvPainting),
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/ -4599,  1355,   3005, /*angle*/   0, 180, 0, /*behParam*/ ((PAINTING_ID_CASTLE_THI_TINY << 24) | (0x97 << 16)), /*beh*/ bhvPainting),
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/  -547,  1357,   3813, /*angle*/   0, 180, 0, /*behParam*/ ((PAINTING_ID_CASTLE_TTM      << 24) | (0x98 << 16)), /*beh*/ bhvPainting),
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/     0,  2714,   7233, /*angle*/   0, 180, 0, /*behParam*/ ((PAINTING_ID_CASTLE_TTC      << 24) | (0x99 << 16)), /*beh*/ bhvPainting),
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/  3180,  1408,   -271, /*angle*/   0,   0, 0, /*behParam*/ ((PAINTING_ID_CASTLE_SL       << 24) | (0x9A << 16)), /*beh*/ bhvPainting),
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/ -5615,  1510,  -3292, /*angle*/   0,   0, 0, /*behParam*/ ((PAINTING_ID_CASTLE_THI_HUGE << 24) | (0x9B << 16)), /*beh*/ bhvPainting),
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/ -3513,  2970,   5989, /*angle*/ 270,   0, 0, /*behParam*/ ((PAINTING_ID_CASTLE_RR       << 24) | (0x9C << 16)), /*beh*/ bhvPainting),
    WARP_NODE(/*id*/ 0x96, /*destLevel*/ LEVEL_WDW,   /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ 0x97, /*destLevel*/ LEVEL_THI,   /*destArea*/ 0x02, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ 0x98, /*destLevel*/ LEVEL_TTM,   /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ 0x99, /*destLevel*/ LEVEL_TTC,   /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ 0x9A, /*destLevel*/ LEVEL_SL,    /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ 0x9B, /*destLevel*/ LEVEL_THI,   /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ 0x9C, /*destLevel*/ LEVEL_RR,    /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  3002, 2816,  5886, /*angle*/ 0,   0, 0, /*behParam*/ 0x0F0A0000, /*beh*/ bhvWarp),
    WARP_NODE(/*id*/ 0x0A, /*destLevel*/ LEVEL_WMOTR, /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  -230, 4813, -3352, /*angle*/ 0,   0, 0, /*behParam*/ 0x0F0B0000, /*beh*/ bhvWarp),
    WARP_NODE(/*id*/ 0x0B, /*destLevel*/ LEVEL_BITS,  /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
...
static const LevelScript script_func_local_3[] = {
    ...
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/ -1690, -1126,  -3942, /*angle*/   0,   0, 0, /*behParam*/ ((PAINTING_ID_CASTLE_LLL << 24) | (0x96 << 16)), /*beh*/ bhvPainting),
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/ -2611, -1178,  -1075, /*angle*/   0, 180, 0, /*behParam*/ ((PAINTING_ID_CASTLE_SSL << 24) | (0x97 << 16)), /*beh*/ bhvPainting),
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/  2099, -1485,  -2278, /*angle*/ 270,   0, 0, /*behParam*/ ((PAINTING_ID_CASTLE_HMC << 24) | (0x98 << 16)), /*beh*/ bhvPainting),
    OBJECT(/*model*/ MODEL_PAINTING, /*pos*/  3456, -1075,   1587, /*angle*/   0, 270, 0, /*behParam*/ ((PAINTING_ID_CASTLE_DDD << 24) | (0x99 << 16)), /*beh*/ bhvPainting),
    WARP_NODE(/*id*/ 0x96, /*destLevel*/ LEVEL_LLL,   /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ 0x97, /*destLevel*/ LEVEL_SSL,   /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ 0x98, /*destLevel*/ LEVEL_HMC,   /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ 0x99, /*destLevel*/ LEVEL_DDD,   /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  4147, -1280,  1997, /*angle*/ 0,   0, 0, /*behParam*/ 0x0F180000, /*beh*/ bhvWarp),
    WARP_NODE(/*id*/ 0x18, /*destLevel*/ LEVEL_BITFS, /*destArea*/ 0x01, /*destNode*/ WARP_NODE_MAIN_ENTRY, /*flags*/ WARP_NO_CHECKPOINT),
