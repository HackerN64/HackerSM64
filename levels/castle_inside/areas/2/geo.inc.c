...
const GeoLayout castle_geo_001668[] = {
   GEO_NODE_START(),
   GEO_OPEN_NODE(),
      GEO_DISPLAY_LIST(LAYER_OPAQUE, inside_castle_seg7_dl_070558D0_inside_castle_seg7_dl_070558D0_mesh_mesh),
      GEO_DISPLAY_LIST(LAYER_OPAQUE, inside_castle_seg7_dl_070572A0_inside_castle_seg7_dl_070572A0_mesh_001_mesh),
