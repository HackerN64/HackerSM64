...
const GeoLayout castle_geo_001578[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM(PAINTING_ID(PAINTING_ID_CASTLE_WDW, PAINTING_GROUP_INSIDE_CASTLE), geo_painting_draw),
      GEO_ASM(PAINTING_ID(PAINTING_ID_CASTLE_TTM, PAINTING_GROUP_INSIDE_CASTLE), geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_0015B8[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM(  0, geo_painting_update),
      GEO_ASM(PAINTING_ID(PAINTING_ID_CASTLE_SL, PAINTING_GROUP_INSIDE_CASTLE), geo_painting_draw),
...
const GeoLayout castle_geo_0015F8[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM(  0, geo_painting_update),
      GEO_ASM(PAINTING_ID(PAINTING_ID_CASTLE_THI_TINY, PAINTING_GROUP_INSIDE_CASTLE), geo_painting_draw),
      GEO_ASM(PAINTING_ID(PAINTING_ID_CASTLE_THI_HUGE, PAINTING_GROUP_INSIDE_CASTLE), geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_001628[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM(  0, geo_painting_update),
      GEO_ASM(PAINTING_ID(PAINTING_ID_CASTLE_TTC, PAINTING_GROUP_INSIDE_CASTLE), geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
