...
const GeoLayout castle_geo_001980[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM(PAINTING_ID(PAINTING_ID_CASTLE_LLL, PAINTING_GROUP_INSIDE_CASTLE), geo_painting_draw),
      GEO_ASM(PAINTING_ID(PAINTING_ID_CASTLE_SSL, PAINTING_GROUP_INSIDE_CASTLE), geo_painting_draw),
...
const GeoLayout castle_geo_0019C8[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM(0, geo_painting_update),
      GEO_ASM(PAINTING_ID(PAINTING_ID_CASTLE_HMC, PAINTING_GROUP_INSIDE_CASTLE), geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_001A30[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM(0, geo_painting_update),
      GEO_ASM(PAINTING_ID(PAINTING_ID_CASTLE_DDD, PAINTING_GROUP_INSIDE_CASTLE), geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
