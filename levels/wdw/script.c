...
static const LevelScript script_wdw_area_1_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  1500,  1741,  2191, /*angle*/ 0, 90, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/   740,  3072, -3560, /*angle*/ 0, 90, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
...
static const LevelScript script_wdw_area_2_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  1089, -1279,   968, /*angle*/ 0, 0, 0,   /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/   100, -1791, -2100, /*angle*/ 0, 90, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  -770,  -320,  2820, /*angle*/ 0, 0, 0,   /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
