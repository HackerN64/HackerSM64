...
const LevelScript level_wdw_entry[] = {
    INIT_LEVEL(),
    LOAD_YAY0(        /*seg*/ SEGMENT_LEVEL_DATA, _wdw_segment_7SegmentRomStart, _wdw_segment_7SegmentRomEnd),
    LOAD_YAY0_TEXTURE(/*seg*/ SEGMENT_TEXTURE, _grass_yay0SegmentRomStart, _grass_yay0SegmentRomEnd),
    LOAD_YAY0(        /*seg*/ SEGMENT_SKYBOX, _wdw_skybox_yay0SegmentRomStart, _wdw_skybox_yay0SegmentRomEnd),
