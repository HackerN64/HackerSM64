...
const LevelScript level_wdw_entry[] = {
    INIT_LEVEL(),
    LOAD_YAZ0(        /*seg*/ 0x07, _wdw_segment_7SegmentRomStart, _wdw_segment_7SegmentRomEnd),
    LOAD_YAZ0_TEXTURE(/*seg*/ 0x09, _grass_yaz0SegmentRomStart, _grass_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0A, _wdw_skybox_yaz0SegmentRomStart, _wdw_skybox_yaz0SegmentRomEnd),
