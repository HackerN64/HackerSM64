...
static const LevelScript script_sl_area_1_macro_objects[] = {
    ...
    // Special objects
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/  5395,  1054, -5443, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/     0,  4864,     0, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/  5666,  1024, -3341, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/  1919,  1024, -4759, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/  3645,  1024, -5889, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/  1658,  1536, -3605, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/ -3769,  1024, -1197, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/ -2745,  1024,  -582, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/  1766,  2816,  -942, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    RETURN(),
};
