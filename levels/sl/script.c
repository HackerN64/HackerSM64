...
static const LevelScript script_sl_area_1_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  -660,  2120,  1340, /*angle*/ 0, 65, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
...
static const LevelScript script_sl_area_2_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  1500,     0,   500, /*angle*/ 0, 90, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
