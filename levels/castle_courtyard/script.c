...
const LevelScript level_castle_courtyard_entry[] = {
    INIT_LEVEL(),
    LOAD_YAY0(        /*seg*/ SEGMENT_LEVEL_DATA, _castle_courtyard_segment_7SegmentRomStart, _castle_courtyard_segment_7SegmentRomEnd),
    LOAD_YAY0(        /*seg*/ SEGMENT_SKYBOX, _water_skybox_yay0SegmentRomStart, _water_skybox_yay0SegmentRomEnd),
    LOAD_YAY0_TEXTURE(/*seg*/ SEGMENT_TEXTURE, _outside_yay0SegmentRomStart, _outside_yay0SegmentRomEnd),
    LOAD_YAY0(        /*seg*/ SEGMENT_GROUPA_YAY0, _group9_yay0SegmentRomStart, _group9_yay0SegmentRomEnd),
    LOAD_RAW(         /*seg*/ SEGMENT_GROUPA_GEO, _group9_geoSegmentRomStart,  _group9_geoSegmentRomEnd),
    ...
    AREA(/*index*/ 1, castle_courtyard_geo_000218),
        ...
        OBJECT(/*model*/ MODEL_NONE, /*pos*/     0,   51, -1400, /*angle*/ 0, 180, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvLaunchStarCollectWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/     0,   51, -1400, /*angle*/ 0, 180, 0, /*behParam*/ 0x000B0000, /*beh*/ bhvLaunchDeathWarp),
