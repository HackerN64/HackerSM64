...
const LevelScript level_ccm_entry[] = {
    INIT_LEVEL(),
    LOAD_YAZ0(        /*seg*/ 0x07, _ccm_segment_7SegmentRomStart, _ccm_segment_7SegmentRomEnd),
    LOAD_YAZ0_TEXTURE(/*seg*/ 0x09, _snow_yaz0SegmentRomStart, _snow_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0B, _effect_yaz0SegmentRomStart, _effect_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0A, _ccm_skybox_yaz0SegmentRomStart, _ccm_skybox_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x05, _group7_yaz0SegmentRomStart, _group7_yaz0SegmentRomEnd),
    LOAD_RAW(         /*seg*/ 0x0C, _group7_geoSegmentRomStart,  _group7_geoSegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x06, _group16_yaz0SegmentRomStart, _group16_yaz0SegmentRomEnd),
