...
static const LevelScript script_ccm_area_1_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/ -5201, -1740,  2994, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/  1989, -4607,  4949, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/  1248, -4607,  5474, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/ -5508, -1740,  4148, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/ -4576, -1740,  4814, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/  -488,  2560, -2305, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/ -5892, -1740,   811, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/ -3748, -4607,  4464, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/  2237,  2560, -1630, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_SNOW_TREE,      /*pos*/  2885,  2560, -1638, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
...
static const LevelScript script_ccm_area_2_macro_objects[] = {
    ...
    // Special objects
    OBJECT(/*model*/ MODEL_WOODEN_DOOR, /*pos*/ -7628, -5836, -6988, /*angle*/ 0, 90, 0,  /*behParam*/ (20 << 16), /*beh*/ bhvDoorWarp),
    RETURN(),
};
