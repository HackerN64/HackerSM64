...
const LevelScript level_jrb_entry[] = {
    INIT_LEVEL(),
    LOAD_YAY0(        /*seg*/ SEGMENT_LEVEL_DATA, _jrb_segment_7SegmentRomStart, _jrb_segment_7SegmentRomEnd),
    LOAD_YAY0(        /*seg*/ SEGMENT_EFFECT_YAY0, _effect_yay0SegmentRomStart, _effect_yay0SegmentRomEnd),
    LOAD_YAY0_TEXTURE(/*seg*/ SEGMENT_TEXTURE, _water_yay0SegmentRomStart, _water_yay0SegmentRomEnd),
    LOAD_YAY0(        /*seg*/ SEGMENT_SKYBOX, _clouds_skybox_yay0SegmentRomStart, _clouds_skybox_yay0SegmentRomEnd),
