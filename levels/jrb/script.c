...
const LevelScript level_jrb_entry[] = {
    INIT_LEVEL(),
    LOAD_YAZ0(        /*seg*/ 0x07, _jrb_segment_7SegmentRomStart, _jrb_segment_7SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0B, _effect_yaz0SegmentRomStart, _effect_yaz0SegmentRomEnd),
    LOAD_YAZ0_TEXTURE(/*seg*/ 0x09, _water_yaz0SegmentRomStart, _water_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0A, _clouds_skybox_yaz0SegmentRomStart, _clouds_skybox_yaz0SegmentRomEnd),
