...
static const LevelScript script_jrb_area_1_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  4220,  1536,  5700, /*angle*/ 0, 45, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  3280,  1536,  5940, /*angle*/ 0, 45, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  3200,  1536,  6720, /*angle*/ 0, 45, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
