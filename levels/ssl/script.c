...
static const LevelScript script_ssl_area_1_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -5920,   200,  -920, /*angle*/ 0, 0, 0,   /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
    OBJECT(/*model*/ MODEL_BOWLING_BALL, /*pos*/  -386,   512, -2228, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000, /*beh*/ bhvFireSpitter),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -2290,   787, -2180, /*angle*/ 0, 90, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
...
static const LevelScript script_ssl_area_2_macro_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  -210,  4521,  -994, /*angle*/ 0, 90, 0,  /*behParam*/ ((0) << 16), /*beh*/ bhvCoinFormation),
