...
const LevelScript level_ssl_entry[] = {
    INIT_LEVEL(),
    LOAD_YAY0(        /*seg*/ SEGMENT_LEVEL_DATA, _ssl_segment_7SegmentRomStart, _ssl_segment_7SegmentRomEnd),
    LOAD_YAY0(        /*seg*/ SEGMENT_SKYBOX, _ssl_skybox_yay0SegmentRomStart, _ssl_skybox_yay0SegmentRomEnd),
    LOAD_YAY0_TEXTURE(/*seg*/ SEGMENT_TEXTURE, _generic_yay0SegmentRomStart, _generic_yay0SegmentRomEnd),
    LOAD_YAY0(        /*seg*/ SEGMENT_GROUPA_YAY0, _group5_yay0SegmentRomStart, _group5_yay0SegmentRomEnd),
    LOAD_RAW(         /*seg*/ SEGMENT_GROUPA_GEO, _group5_geoSegmentRomStart,  _group5_geoSegmentRomEnd),
