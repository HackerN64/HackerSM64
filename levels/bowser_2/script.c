...
const LevelScript level_bowser_2_entry[] = {
    ...
    LOAD_YAZ0(        /*seg*/ 0x07, _bowser_2_segment_7SegmentRomStart, _bowser_2_segment_7SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x06, _group12_yaz0SegmentRomStart, _group12_yaz0SegmentRomEnd),
