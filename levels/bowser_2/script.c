...
const LevelScript level_bowser_2_entry[] = {
    ...
    AREA(/*index*/ 1, bowser_2_geo_000188),
        ...
        WARP_NODE(/*id*/ WARP_NODE_DEFAULT, /*destLevel*/ LEVEL_CASTLE,   /*destArea*/ 0x03, /*destNode*/ 0x36, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH,   /*destLevel*/ LEVEL_BITFS,    /*destArea*/ 0x01, /*destNode*/ 0x0C, /*flags*/ WARP_NO_CHECKPOINT),
