...
const LevelScript level_sa_entry[] = {
    INIT_LEVEL(),
    LOAD_YAZ0(        /*seg*/ 0x07, _sa_segment_7SegmentRomStart, _sa_segment_7SegmentRomEnd),
    LOAD_YAZ0_TEXTURE(/*seg*/ 0x09, _inside_yaz0SegmentRomStart, _inside_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0A, _cloud_floor_skybox_yaz0SegmentRomStart, _cloud_floor_skybox_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x0B, _effect_yaz0SegmentRomStart, _effect_yaz0SegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x05, _group4_yaz0SegmentRomStart, _group4_yaz0SegmentRomEnd),
    LOAD_RAW(         /*seg*/ 0x0C, _group4_geoSegmentRomStart,  _group4_geoSegmentRomEnd),
    LOAD_YAZ0(        /*seg*/ 0x06, _group13_yaz0SegmentRomStart, _group13_yaz0SegmentRomEnd),
