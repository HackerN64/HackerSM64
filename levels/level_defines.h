...
// Argument 7, 8, 9: Echo levels for individual areas. < Hackers should change these for their levels btw
...
DEFINE_LEVEL("OW 2 IN CASTLE", LEVEL_CASTLE,           COURSE_NONE,     castle_inside,    inside,   20000, 0x20, 0x20, 0x30, _,         sCamCastle)
...
DEFINE_LEVEL("OW 1 C GROUNDS", LEVEL_CASTLE_GROUNDS,   COURSE_NONE,     castle_grounds,   outside,  25000, 0x08, 0x08, 0x08, _,         _)
DEFINE_LEVEL("BC 1 BITDW",     LEVEL_BITDW,            COURSE_BITDW,    bitdw,            sky,      16000, 0x28, 0x28, 0x28, _,         _)
DEFINE_LEVEL("VCL VCUTM",      LEVEL_VCUTM,            COURSE_VCUTM,    vcutm,            outside,  30000, 0x28, 0x28, 0x28, _,         _)
DEFINE_LEVEL("BC 2 BITFS",     LEVEL_BITFS,            COURSE_BITFS,    bitfs,            sky,      16000, 0x28, 0x28, 0x28, _,         _)
DEFINE_LEVEL("SC 1 SEC AQUA",  LEVEL_SA,               COURSE_SA,       sa,               inside,   20000, 0x10, 0x10, 0x10, _,         _)
DEFINE_LEVEL("BC 3 BITS",      LEVEL_BITS,             COURSE_BITS,     bits,             sky,      16000, 0x28, 0x28, 0x28, _,         _)
...
DEFINE_LEVEL("OW 3 C COURTYD", LEVEL_CASTLE_COURTYARD, COURSE_NONE,     castle_courtyard, outside,  20000, 0x08, 0x08, 0x08, _,         _)
...
DEFINE_LEVEL("B BATTLE 1",     LEVEL_BOWSER_1,         COURSE_BITDW,    bowser_1,         generic,  60000, 0x40, 0x40, 0x40, _,         _)
DEFINE_LEVEL("SC 2 WMOTR",     LEVEL_WMOTR,            COURSE_WMOTR,    wmotr,            generic,  20000, 0x28, 0x28, 0x28, _,         _)
STUB_LEVEL(  "",               LEVEL_UNKNOWN_32,       COURSE_NONE,                                 20000, 0x70, 0x00, 0x00, _,         _)
DEFINE_LEVEL("B BATTLE 2",     LEVEL_BOWSER_2,         COURSE_BITFS,    bowser_2,         fire,     60000, 0x40, 0x40, 0x40, _,         _)
DEFINE_LEVEL("B BATTLE 3",     LEVEL_BOWSER_3,         COURSE_BITS,     bowser_3,         generic,  60000, 0x40, 0x40, 0x40, _,         _)
