...
DEFINE_LEVEL("COURSE 6 PPF", LEVEL_PPF, COURSE_PPF, ppf, generic, 20000, 0x00, 0x00, 0x00, _, _) 
STUB_LEVEL("COURSE 7 YI", LEVEL_YI, COURSE_NONE, 20000, 0x00, 0x00, 0x00, _, _) 
STUB_LEVEL("COURSE 9 BBF", LEVEL_BBF, COURSE_NONE, 20000, 0x00, 0x00, 0x00, _, _) 
...
STUB_LEVEL("B BATTLE4", LEVEL_BOWSER_4, COURSE_NONE, 20000, 0x70, 0x00, 0x00, _, _) 
...
STUB_LEVEL("B BATTLE5", LEVEL_BOWSER_5, COURSE_NONE, 20000, 0x00, 0x00, 0x00, _, _) 
DEFINE_LEVEL("COURSE 12 TTM", LEVEL_TTM, COURSE_TTM, ttm, mountain, 15000, 0x08, 0x08, 0x08, _, _) 
STUB_LEVEL("COURSE 11 BBF1", LEVEL_BBF1, COURSE_NONE, 20000, 0x00, 0x00, 0x00, _, _) 
STUB_LEVEL("COURSE 13 DBD", LEVEL_DBD, COURSE_NONE, 20000, 0x00, 0x00, 0x00, sDynUnk38, _) 
