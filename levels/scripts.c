...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_SAMPLE_CUBE,            physcube_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SAMPLE_SPHERE,            physsphere_geo),
    LOAD_MODEL_FROM_GEO(MODEL_M_BODY,            m_body_geo),
    LOAD_MODEL_FROM_GEO(MODEL_M_HEAD,            m_head_geo),
    LOAD_MODEL_FROM_GEO(MODEL_M_SHOULDER_L,            m_shoulder_l_geo),
    LOAD_MODEL_FROM_GEO(MODEL_M_SHOULDER_R,            m_shoulder_r_geo),
    LOAD_MODEL_FROM_GEO(MODEL_M_ARM_L,            m_arm_l_geo),
    LOAD_MODEL_FROM_GEO(MODEL_M_ARM_R,            m_arm_r_geo),
    LOAD_MODEL_FROM_GEO(MODEL_M_HAND_L,            m_hand_l_geo),
    LOAD_MODEL_FROM_GEO(MODEL_M_HAND_R,            m_hand_r_geo),
    LOAD_MODEL_FROM_GEO(MODEL_M_THIGH_L,            m_thigh_l_geo),
    LOAD_MODEL_FROM_GEO(MODEL_M_THIGH_R,            m_thigh_r_geo),
    LOAD_MODEL_FROM_GEO(MODEL_M_LEG_L,            m_leg_l_geo),
    LOAD_MODEL_FROM_GEO(MODEL_M_LEG_R,            m_leg_r_geo),
    LOAD_MODEL_FROM_GEO(MODEL_M_FOOT_L,            m_foot_l_geo),
    LOAD_MODEL_FROM_GEO(MODEL_M_FOOT_R,            m_foot_r_geo),
