...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_RAW_WITH_CODE( /*seg*/ SEGMENT_COMMON0_GEO,   _common0_geoSegmentRomStart,  _common0_geoSegmentRomEnd, _common0_geoSegmentBssStart, _common0_geoSegmentBssEnd),
