...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_WOODEN_DOOR,             wooden_door_geo),
    LOAD_MODEL_FROM_GEO(MODEL_METAL_DOOR,              metal_door_geo),
    LOAD_MODEL_FROM_GEO(MODEL_CASTLE_DOOR,             castle_door_geo),
