...
enum SurfaceTypes {
    ...
    SURFACE_PAINTING_WOBBLE_B8,         // 0x00B8 // Painting wobble (PPF Left)
    SURFACE_PAINTING_WOBBLE_B9,         // 0x00B9 // Painting wobble (PPF Middle)
    SURFACE_PAINTING_WOBBLE_BA,         // 0x00BA // Painting wobble (PPF Right)
    ...
    SURFACE_PAINTING_WARP_E5,           // 0x00E5 // Painting warp (PPF Left)
    SURFACE_PAINTING_WARP_E6,           // 0x00E6 // Painting warp (PPF Medium)
    SURFACE_PAINTING_WARP_E7,           // 0x00E7 // Painting warp (PPF Right)
