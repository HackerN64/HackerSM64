...
#define STATIC_ASSERT_STRUCT_SIZE_EQ(_T, _size) STATIC_ASSERT((sizeof(_T) == (size_t)(_size)), "Incorrect size of "EXPAND_AND_STRINGIFY(_T))
#define STATIC_ASSERT_STRUCT_SIZE_LE(_T, _size) STATIC_ASSERT((sizeof(_T) <= (size_t)(_size)), "Incorrect size of "EXPAND_AND_STRINGIFY(_T))
