 ...
 *
 */
#define PIF_ROM_SIZE		(0x07C0 - 1)
#define PIF_ROM_START		0x1FC00000
#define PIF_ROM_END		(PIF_ROM_START + PIF_ROM_SIZE) /* 0x1FC007BF */

#define PIF_RAM_SIZE		(0x0040 - 1)
#define PIF_RAM_START		(PIF_ROM_END   + 1           ) /* 0x1FC007C0 */
#define PIF_RAM_END		(PIF_RAM_START + PIF_RAM_SIZE) /* 0x1FC007FF */
