...
/* DMA commands: */
#define	G_SPNOOP			0x00	/* handle 0 gracefully */
#define	G_MTX				0x01
#define	G_RESERVED0			0x02	/* not implemeted */
#define	G_MOVEMEM			0x03	/* move a block of memory (up to 4 words) to dmem */
#define	G_VTX				0x04
#define	G_RESERVED1			0x05	/* not implemeted */
#define	G_DL				0x06
#define	G_RESERVED2			0x07	/* not implemeted */
#define	G_RESERVED3			0x08	/* not implemeted */
#define	G_SPRITE2D_BASE		0x09	/* sprite command */
...
#define	G_RDP_TRI_FILL_MASK		(1 << 3) // 0x08
#define	G_RDP_TRI_SHADE_MASK	(1 << 2) // 0x04
#define	G_RDP_TRI_TXTR_MASK		(1 << 1) // 0x02
#define	G_RDP_TRI_ZBUFF_MASK	(1 << 0) // 0x01
 ...
 */
#define	BOWTIE_VAL			0x0

/* gets added to RDP command, in order to test for addres fixup: */
#define	G_RDP_ADDR_FIXUP	0x3	/* |RDP cmds| <= this, do addr fixup */
...
#define	G_DMACMDSIZ				(1 << 7)	// 0x80
#define	G_IMMCMDSIZ				(1 << 6)	// 0x40
#define	G_RDPCMDSIZ				(1 << 6)	// 0x40

/*
 * Coordinate shift values, number of bits of fraction
 */
#define	G_TEXTURE_IMAGE_FRAC	(1 << 1)	// 0x02
#define	G_TEXTURE_SCALE_FRAC	(1 << 4)	// 0x10
#define	G_SCALE_FRAC			(1 << 3)	// 0x08
#define	G_ROTATE_FRAC			(1 << 4)	// 0x10
 ...
 */
#ifdef	F3DEX_GBI_2
#define	G_MTX_MODELVIEW		(0 << 2) // 0x00	/* matrix types */
#define	G_MTX_PROJECTION	(1 << 2) // 0x04
#define	G_MTX_MUL			(0 << 1) // 0x00	/* concat or load */
#define	G_MTX_LOAD			(1 << 1) // 0x02
#define	G_MTX_NOPUSH		(0 << 0) // 0x00	/* push or not */
#define	G_MTX_PUSH			(1 << 0) // 0x01
#else	/* F3DEX_GBI_2 */
#define	G_MTX_MODELVIEW		(0 << 0) // 0x00	/* matrix types */
#define	G_MTX_PROJECTION	(1 << 0) // 0x01
#define	G_MTX_MUL			(0 << 1) // 0x00	/* concat or load */
#define	G_MTX_LOAD			(1 << 1) // 0x02
#define	G_MTX_NOPUSH		(0 << 2) // 0x00	/* push or not */
#define	G_MTX_PUSH			(1 << 2) // 0x04
#endif	/* F3DEX_GBI_2 */
 ...
 *
 */
#define	G_ZBUFFER				(1 <<  0)						// 0x00000001
#define	G_SHADE					(1 <<  2)						// 0x00000004	/* enable Gouraud interp */
/* rest of low byte reserved for setup ucode */
#ifdef	F3DEX_GBI_2
#define	G_TEXTURE_ENABLE		(0 <<  0)						// 0x00000000	/* Ignored               */
#define	G_SHADING_SMOOTH		(1 << 21)						// 0x00200000	/* flat or smooth shaded */
#define	G_CULL_FRONT			(1 <<  9) 						// 0x00000200
#define	G_CULL_BACK				(1 << 10) 						// 0x00000400
#define	G_CULL_BOTH				(G_CULL_FRONT | G_CULL_BACK)	// 0x00000600	/* To make code cleaner */
#else
#define	G_TEXTURE_ENABLE		(1 <<  1)						// 0x00000002	/* Microcode use only */
#define	G_SHADING_SMOOTH		(1 <<  9)						// 0x00000200	/* flat or smooth shaded */
#define	G_CULL_FRONT			(1 << 12)						// 0x00001000
#define	G_CULL_BACK				(1 << 13)						// 0x00002000
#define	G_CULL_BOTH				(G_CULL_FRONT | G_CULL_BACK)	// 0x00003000	/* To make code cleaner */
#endif
#define	G_FOG					(1 << 16)						// 0x00010000
#define	G_LIGHTING				(1 << 17)						// 0x00020000
#define	G_TEXTURE_GEN			(1 << 18)						// 0x00040000
#define	G_TEXTURE_GEN_LINEAR	(1 << 19)						// 0x00080000
#define	G_LOD					(1 << 20)						// 0x00100000	/* NOT IMPLEMENTED */
#if	(defined(F3DEX_GBI) || defined(F3DLP_GBI))
#define	G_CLIPPING				(1 << 23)						// 0x00800000
#else
#define	G_CLIPPING				(0 << 23)						// 0x00000000
#endif

#ifdef	_LANGUAGE_ASSEMBLY
#define	G_FOG_H					(G_FOG                >> 16)	// / 0x10000
#define	G_LIGHTING_H			(G_LIGHTING           >> 16)	// / 0x10000
#define	G_TEXTURE_GEN_H			(G_TEXTURE_GEN        >> 16)	// / 0x10000
#define	G_TEXTURE_GEN_LINEAR_H	(G_TEXTURE_GEN_LINEAR >> 16)	// / 0x10000
#define	G_LOD_H					(G_LOD                >> 16)	// / 0x10000	/* NOT IMPLEMENTED */
#if	(defined(F3DEX_GBI) || defined(F3DLP_GBI))
#define	G_CLIPPING_H			(G_CLIPPING           >> 16)	// / 0x10000
#endif
#endif
 ...
 */
#define	G_IM_FMT_RGBA			0x0
#define	G_IM_FMT_YUV			0x1
#define	G_IM_FMT_CI				0x2
#define	G_IM_FMT_IA				0x3
#define	G_IM_FMT_I				0x4

/*
 * G_SETIMG siz: set image pixel size
 */
#define	G_IM_SIZ_4b				0x0
#define	G_IM_SIZ_8b				0x1
#define	G_IM_SIZ_16b			0x2
#define	G_IM_SIZ_32b			0x3
#define	G_IM_SIZ_DD				0x5

#define	G_IM_SIZ_4b_BYTES		0x0
#define	G_IM_SIZ_4b_TILE_BYTES	G_IM_SIZ_4b_BYTES
#define	G_IM_SIZ_4b_LINE_BYTES	G_IM_SIZ_4b_BYTES

#define	G_IM_SIZ_8b_BYTES		0x1
#define	G_IM_SIZ_8b_TILE_BYTES	G_IM_SIZ_8b_BYTES
#define	G_IM_SIZ_8b_LINE_BYTES	G_IM_SIZ_8b_BYTES

#define	G_IM_SIZ_16b_BYTES		0x2
#define	G_IM_SIZ_16b_TILE_BYTES	G_IM_SIZ_16b_BYTES
#define	G_IM_SIZ_16b_LINE_BYTES	G_IM_SIZ_16b_BYTES

#define	G_IM_SIZ_32b_BYTES		0x4
#define	G_IM_SIZ_32b_TILE_BYTES	0x2
#define	G_IM_SIZ_32b_LINE_BYTES	0x2
...
#define	G_IM_SIZ_4b_SHIFT		0x2
#define	G_IM_SIZ_8b_SHIFT		0x1
#define	G_IM_SIZ_16b_SHIFT		0x0
#define	G_IM_SIZ_32b_SHIFT		0x0

#define	G_IM_SIZ_4b_INCR		0x3
#define	G_IM_SIZ_8b_INCR		0x1
#define	G_IM_SIZ_16b_INCR		0x0
#define	G_IM_SIZ_32b_INCR		0x0
...
#define G_CC_PRIMSHADEA               PRIMITIVE,           0,         SHADE,           0,           0,        0,             0, ENVIRONMENT
...
#define	G_CC_HILITERGBA2            ENVIRONMENT,    COMBINED,        TEXEL0,    COMBINED, ENVIRONMENT, COMBINED,         EXEL0,    COMBINED
...
#define	TEX_EDGE		(0 << 15) // 0x0000 /* used to be (1 << 15) // 0x8000 */
 ...
 */
#define	G_SC_NON_INTERLACE	0x0
#define	G_SC_ODD_INTERLACE	0x3
#define	G_SC_EVEN_INTERLACE	0x2

/* flags to inhibit pushing of the display list (on branch) */
#define	G_DL_PUSH			0x0
#define	G_DL_NOPUSH			0x1
...
#define	gdSPDefLights2(ar,ag,ab, r1,g1,b1, x1,y1,z1,							\
					 			 r2,g2,b2, x2,y2,z2)							\
		{ 	{{ {ar,ag,ab}, 0, {ar,ag,ab}, 0}},									\
		   {{{ {r1,g1,b1}, 0, {r1,g1,b1}, 0, {x1,y1,z1}, 0}},					\
			{{ {r2,g2,b2}, 0, {r2,g2,b2}, 0, {x2,y2,z2}, 0}}} }
#define	gdSPDefLights3(ar,ag,ab, r1,g1,b1, x1,y1,z1,							\
								 r2,g2,b2, x2,y2,z2,							\
								 r3,g3,b3, x3,y3,z3)							\
		{ 	{{ {ar,ag,ab}, 0, {ar,ag,ab}, 0}},									\
		   {{{ {r1,g1,b1}, 0, {r1,g1,b1}, 0, {x1,y1,z1}, 0}},					\
...
#define	gdSPDefLights4(ar,ag,ab, r1,g1,b1, x1,y1,z1,							\
								 r2,g2,b2, x2,y2,z2,							\
								 r3,g3,b3, x3,y3,z3,							\
								 r4,g4,b4, x4,y4,z4)							\
		{ 	{{ {ar,ag,ab}, 0, {ar,ag,ab}, 0}},									\
...
#define	gdSPDefLights5(ar,ag,ab, r1,g1,b1, x1,y1,z1,							\
								 r2,g2,b2, x2,y2,z2,							\
								 r3,g3,b3, x3,y3,z3,							\
								 r4,g4,b4, x4,y4,z4,							\
								 r5,g5,b5, x5,y5,z5)							\
...
#define	gdSPDefLights6(ar,ag,ab, r1,g1,b1, x1,y1,z1,							\
								 r2,g2,b2, x2,y2,z2,							\
								 r3,g3,b3, x3,y3,z3,							\
								 r4,g4,b4, x4,y4,z4,							\
								 r5,g5,b5, x5,y5,z5,							\
...
#define	gdSPDefLights7(ar,ag,ab, r1,g1,b1, x1,y1,z1,							\
								 r2,g2,b2, x2,y2,z2,							\
								 r3,g3,b3, x3,y3,z3,							\
								 r4,g4,b4, x4,y4,z4,							\
								 r5,g5,b5, x5,y5,z5,							\
...
{																				\
	Gfx *_g = (Gfx *)(pkt);														\
	_g->words.w0 = (_SHIFTL((c), 24, 8) | _SHIFTL((((len) - 1) >> 3), 19, 5) |	\
					_SHIFTL(((ofs) >> 3), 8, 8) | _SHIFTL((idx), 0, 8));		\
	_g->words.w1 = (uintptr_t)(adrs);											\
}
#define	gsDma2p(c, adrs, len, idx, ofs)											\
{{																				\
	(_SHIFTL((c), 24, 8) | _SHIFTL((((len) - 1) >> 3), 19, 5) |					\
	 _SHIFTL(((ofs) >> 3), 8, 8) | _SHIFTL((idx), 0, 8)),						\
		(uintptr_t)(adrs)														\
}}
 ...
 *        +-+---+-----------------------------+
 */
#define	gSPVertex(pkt, v, n, v0)	gDma1p((pkt), G_VTX,     (v), (((n) << 10) | ((sizeof(Vtx) * (n)) - 1)), ((v0) << 1))
#define	gsSPVertex(    v, n, v0)	gsDma1p(      G_VTX,     (v), (((n) << 10) | ((sizeof(Vtx) * (n)) - 1)), ((v0) << 1))
#else
...
#define	__gsSP1Triangle_w1(v0, v1, v2)											\
	 (_SHIFTL((v0) << 1, 16, 8) | _SHIFTL((v1) << 1, 8, 8) | _SHIFTL((v2) << 1, 0, 8))
...
#define	__gsSPLine3D_w1(v0, v1, wd)												\
	 (_SHIFTL((v0) << 1, 16, 8) | _SHIFT((v1) << 1, 8, 8) | _SHIFT((wd), 0, 8))
...
{																				\
	...
	_g->words.w0 = _SHIFTL     (G_CULLDL, 24,  8) |								\
				   _SHIFTL((vstart) << 1,  0, 16);								\
	_g->words.w1 = _SHIFTL(  (vend) << 1,  0, 16);								\
}

#define	gsSPCullDisplayList(vstart, vend)										\
{{																				\
	_SHIFTL(G_CULLDL, 24, 8) | _SHIFTL((vstart) << 1, 0, 16),					\
	_SHIFTL((vend) << 1, 0, 16)													\
}}
...
{																				\
	...
	_g->words.w0 = (_SHIFTL(G_MODIFYVTX, 24, 8) |								\
					_SHIFTL((where), 16, 8) | _SHIFTL(((vtx) << 1), 0, 16));	\
...
#define	G_BZ_PERSP	0x0
#define	G_BZ_ORTHO	0x1
...
{																				\
	...
	_g->words.w0 = (_SHIFTL(G_BRANCH_Z, 24, 8) |								\
				_SHIFTL(((vtx) * 5), 12, 12) | _SHIFTL(((vtx) << 1), 0, 12));	\
...
{																				\
	...
	_g->words.w0 = _SHIFTL(G_DMA_IO, 24, 8) | _SHIFTL((flag), 23, 1) |			\
	  _SHIFTL(((dmem) >> 3), 13, 10) | _SHIFTL((size) - 1, 0, 12);				\
...
#define	NUML(n)	  ((n) * 24)
#else
#define	NUML(n)	((((n) + 1) << 5) + 0x80000000)
#endif
...
#else	/* F3DEX_GBI_2 */
#define	gSPLight(pkt, l, n) gDma1p( pkt,  G_MOVEMEM,  l,  sizeof(Light), ((((n) - 1) << 1) + G_MV_L0))
#define	gsSPLight(    l, n) gsDma1p(      G_MOVEMEM,  l,  sizeof(Light), ((((n) - 1) << 1) + G_MV_L0))
#endif	/* F3DEX_GBI_2 */
...
#define	gDPSetHilite1Tile(pkt, tile, hilite, width, height) gDPSetTileSize(pkt, tile, (hilite)->h.x1 & 0xFFF, (hilite)->h.y1 & 0xFFF, ((((width) - 1) << 2) + (hilite)->h.x1) & 0xFFF, ((((height) - 1) << 2) + (hilite)->h.y1) & 0xFFF)
#define	gDPSetHilite2Tile(pkt, tile, hilite, width, height) gDPSetTileSize(pkt, tile, (hilite)->h.x2 & 0xFFF, (hilite)->h.y2 & 0xFFF, ((((width) - 1) << 2) + (hilite)->h.x2) & 0xFFF, ((((height) - 1) << 2) + (hilite)->h.y2) & 0xFFF)
...
#define	TXL2WORDS(txls, b_txl)	MAX(1, (((txls) * (b_txl)) >> 3)) // / 4
#define	CALC_DXT(width, b_txl)													\
		(((1 << G_TX_DXT_FRAC) + TXL2WORDS(width, b_txl) - 1) / 				\
					TXL2WORDS(width, b_txl))

#define	TXL2WORDS_4b(txls)	MAX(1, ((txls) >> 4)) // / 16
...
{																				\
	...
	for((_loadtile_i = 0); (_loadtile_i < _loadtile_nw); (_loadtile_i++)) pkt;	\
}
...
{																				\
	...
	gDPTileSync(pkt);															\
	gDPSetTile(pkt, 0, 0, 0, (256 + (((pal) & 0xF) << 4)),						\
...
#define	gDPLoadTLUT_pal16(pkt, pal, dram)										\
		_gDPLoadTextureBlock(pkt, dram, (256 + (((pal) & 0xF) << 4)),			\
		G_IM_FMT_RGBA, G_IM_SIZ_16b, (4 << 4), 1,								\
		pal, 0, 0, 0, 0, 0, 0)
...
#define	gsDPLoadTLUT_pal16(pal, dram)											\
	...
	gsDPTileSync(),																\
	gsDPSetTile(0, 0, 0, (256 + (((pal) & 0xF) << 4)),							\
				G_TX_LOADTILE, 0, 0, 0, 0, 0, 0, 0),							\
	gsDPLoadSync(),																\
...
#define	gsDPLoadTLUT_pal16(pal, dram)											\
	_gsDPLoadTextureBlock(dram, (256 + (((pal) & 0xF) << 4)),					\
				G_IM_FMT_RGBA, G_IM_SIZ_16b, (4 << 4), 1,						\
				pal, 0, 0, 0, 0, 0, 0)
...
#define	gDPLoadTLUT_pal256(pkt, dram)											\
	_gDPLoadTextureBlock(pkt, dram, 256,										\
				G_IM_FMT_RGBA, G_IM_SIZ_16b, (4 << 8), 1,						\
				0, 0, 0, 0, 0, 0, 0)
...
{{																				\
	...
	(_SHIFTL(cG, 24, 8) | _SHIFTL(sG, 16, 8) |									\
	 _SHIFTL(cB,  8, 8) | _SHIFTL(sB,  0, 8))									\
}}
