...
// Shades
#define COLOR_RGBA32_LIGHT_RED                  0xFF7F7FFF // 255 127 127 255
#define COLOR_RGBA32_LIGHT_YELLOW               0xFFFF7FFF // 255 255 127 255
#define COLOR_RGBA32_VERY_LIGHT_YELLOW          0xFFFFBFFF // 255 255 191 255
#define COLOR_RGBA32_LIGHT_GREEN                0x7FFF7FFF // 127 255 127 255
#define COLOR_RGBA32_VERY_LIGHT_CYAN            0xBFFFFFFF // 191 255 255 255
#define COLOR_RGBA32_LIGHT_SKY                  0x7FBFFFFF // 127 191 255 255
#define COLOR_RGBA32_LIGHT_BLUE                 0x7F7FFFFF // 127 127 255 255
#define COLOR_RGBA32_VERY_LIGHT_BLUE            0xBFBFFFFF // 191 191 255 255
...
// Crash screen
#define COLOR_RGBA32_CRASH_DISASM_INST          COLOR_RGBA32_VERY_LIGHT_YELLOW
...
#define COLOR_RGBA32_CRASH_DISASM_REG_2         COLOR_RGBA32_VERY_LIGHT_CYAN
#define COLOR_RGBA32_CRASH_FUNCTION_NAME        COLOR_RGBA32_LIGHT_YELLOW
#define COLOR_RGBA32_CRASH_FUNCTION_NAME_2      COLOR_RGBA32_VERY_LIGHT_YELLOW
#define COLOR_RGBA32_CRASH_REGISTER             0x3FBF7FFF //  63 191 127 255
#define COLOR_RGBA32_CRASH_DESCRIPTION          0xFF3F00FF // 255  63   0 255
#define COLOR_RGBA32_CRASH_THREAD               COLOR_RGBA32_LIGHT_BLUE
#define COLOR_RGBA32_CRASH_AT                   COLOR_RGBA32_LIGHT_RED
#define COLOR_RGBA32_CRASH_PC                   0xFF00007F
#define COLOR_RGBA32_CRASH_CONTROLS             COLOR_RGBA32_LIGHT_GRAY
...
#define COLOR_RGBA32_CRASH_RAM_VIEW_H1          0x00B7FFFF //   0 191 255 255
#define COLOR_RGBA32_CRASH_RAM_VIEW_H2          0x0087FFFF //   0 135 255 255
#define COLOR_RGBA32_CRASH_RAM_VIEW_B1          0x5FDF5FFF //  95 223  95 255
#define COLOR_RGBA32_CRASH_RAM_VIEW_B2          0x1F9F1FFF //  31 159  31 255
#define COLOR_RGBA32_CRASH_SELECT               0x7F7F7FBF
#define COLOR_RGBA32_CRASH_SELECT_ARROWS        COLOR_RGBA32_ORANGE
#define COLOR_RGBA32_CRASH_ERROR                0x5F4747FF //  95  71  71 255
#define COLOR_RGBA32_CRASH_BACKGROUND           0x000000BF //   0   0   0 191
#define COLOR_RGBA32_CRASH_BACKGROUND_2         0x000000DF //   0   0   0 223
...
#define COLOR_RGBA_LIGHT_SKY                    RGBA32_TO_COLORRGBA(COLOR_RGBA32_LIGHT_SKY)
...
// Crash screen
#define COLOR_RGBA_CRASH_DISASM_INST            RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_DISASM_INST)
...
#define COLOR_RGBA_CRASH_DISASM_REG_2           RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_DISASM_REG_2)
#define COLOR_RGBA_CRASH_FUNCTION_NAME          RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_FUNCTION_NAME)
#define COLOR_RGBA_CRASH_FUNCTION_NAME_2        RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_FUNCTION_NAME_2)
#define COLOR_RGBA_CRASH_REGISTER               RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_REGISTER)
#define COLOR_RGBA_CRASH_DESCRIPTION            RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_DESCRIPTION)
#define COLOR_RGBA_CRASH_THREAD                 RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_THREAD)
#define COLOR_RGBA_CRASH_AT                     RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_AT)
#define COLOR_RGBA_CRASH_PC                     RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_PC)
#define COLOR_RGBA_CRASH_CONTROLS               RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_CONTROLS)
#define COLOR_RGBA_CRASH_HEADER                 RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_HEADER)
#define COLOR_RGBA_CRASH_DIVIDER                RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_DIVIDER)
#define COLOR_RGBA_CRASH_PAGE_NAME              RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_PAGE_NAME)
#define COLOR_RGBA_CRASH_FILE_NAME              RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_FILE_NAME)
#define COLOR_RGBA_CRASH_RAM_VIEW_H1            RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_RAM_VIEW_H1)
#define COLOR_RGBA_CRASH_RAM_VIEW_H2            RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_RAM_VIEW_H2)
#define COLOR_RGBA_CRASH_RAM_VIEW_B1            RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_RAM_VIEW_B1)
#define COLOR_RGBA_CRASH_RAM_VIEW_B2            RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_RAM_VIEW_B2)
#define COLOR_RGBA_CRASH_SELECT                 RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_SELECT)
#define COLOR_RGBA_CRASH_SELECT_ARROWS          RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_SELECT_ARROWS)
#define COLOR_RGBA_CRASH_ERROR                  RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_ERROR)
#define COLOR_RGBA_CRASH_BACKGROUND             RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_BACKGROUND)
#define COLOR_RGBA_CRASH_BACKGROUND_2           RGBA32_TO_COLORRGBA(COLOR_RGBA32_CRASH_BACKGROUND_2)
