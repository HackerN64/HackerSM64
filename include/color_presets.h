...
#define COLOR_RGBA32_CRASH_SCROLL_BAR           COLOR_RGBA32_WHITE
#define COLOR_RGBA32_CRASH_DIVIDER              COLOR_RGBA32_LIGHT_GRAY
#define COLOR_RGBA32_CRASH_DIVIDER_TRANSLUCENT  RGBA32_SET_ALPHA(COLOR_RGBA32_CRASH_DIVIDER, 0x7F)
// Generic:
#define COLOR_RGBA32_CRASH_DESCRIPTION_MAIN     0xFF3F00FF // 255  31   0 255
...
// Symbols:
#define COLOR_RGBA32_CRASH_UNKNOWN              COLOR_RGBA32_GRAY
...
#define COLOR_RGBA32_CRASH_RUNNING_HIGHLIGHT    RGBA32_SET_ALPHA(COLOR_RGBA32_LIGHT_GREEN,  0x3F) // 0x7FFF7F3F // 127 255 127  63
#define COLOR_RGBA32_CRASH_INSPECT_HIGHLIGHT    RGBA32_SET_ALPHA(COLOR_RGBA32_CRASH_THREAD_PRI, 0x5F) // 0x7FFFFF5F // 127 255 255 127
#define COLOR_RGBA32_CRASH_SELECT_ARROW         COLOR_RGBA32_ORANGE
// Thread Registers:
#define COLOR_RGBA32_CRASH_THREAD_NAME          COLOR_RGBA32_VSC_ENUM
#define COLOR_RGBA32_CRASH_THREAD_PRI           COLOR_RGBA32_LIGHT_BLUE
// Interface Registers:
#define COLOR_RGBA32_CRASH_INTERFACE            COLOR_RGBA32_CYAN
#define COLOR_RGBA32_CRASH_INTERFACE_REG        COLOR_RGBA32_VSC_DEFINE
// Assert:
#define COLOR_RGBA32_CRASH_FILE_NAME            COLOR_RGBA32_LIGHT_BLUE
// Map:
...
#define COLOR_RGBA32_CRASH_DISASM_REGOFFSET     COLOR_RGBA32_LIGHT_GREEN
#define COLOR_RGBA32_CRASH_DISASM_IMMEDIATE     COLOR_RGBA32_VSC_NUMBER
// Settings:
...
#define COLOR_RGBA16_NONE                       RGBA32_TO_RGBA16(COLOR_RGBA32_NONE      ) // 0b0000000000000000 | 0000 0000 0000 0000 | 00000 00000 00000 0 | 0x0000 |  0  0  0  0
#define COLOR_RGBA16_BLACK                      RGBA32_TO_RGBA16(COLOR_RGBA32_BLACK     ) // 0b0000000000000001 | 0000 0000 0000 0001 | 00000 00000 00000 1 | 0x0001 |  0  0  0  1
#define COLOR_RGBA16_DARK_GRAY                  RGBA32_TO_RGBA16(COLOR_RGBA32_DARK_GRAY ) // 0b0011100111001111 | 0011 1001 1100 1111 | 00111 00111 00111 1 | 0x39CF |  7  7  7  1
#define COLOR_RGBA16_GRAY                       RGBA32_TO_RGBA16(COLOR_RGBA32_GRAY      ) // 0b0111101111011111 | 0111 1011 1101 1111 | 01111 01111 01111 1 | 0x7BDF | 15 15 15  1
#define COLOR_RGBA16_LIGHT_GRAY                 RGBA32_TO_RGBA16(COLOR_RGBA32_LIGHT_GRAY) // 0b1011110111101111 | 1011 1101 1110 1111 | 10111 10111 10111 1 | 0xBDEF | 23 23 23  1
#define COLOR_RGBA16_WHITE                      RGBA32_TO_RGBA16(COLOR_RGBA32_WHITE     ) // 0b1111111111111111 | 1111 1111 1111 1111 | 11111 11111 11111 1 | 0xFFFF | 31 31 31  1
