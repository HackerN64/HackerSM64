...
struct MacroPreset MacroObjectPresets[] = {
    ...
    {bhvGoomba,                         MODEL_GOOMBA,                       1}, // macro_huge_goomba
    {bhvGoomba,                         MODEL_GOOMBA,                       2}, // macro_tiny_goomba
    ...
    {bhv1Up,                            MODEL_1UP,                          1}, // macro_1up_2
    {bhv1Up,                            MODEL_1UP,                          2}, // macro_1up_3
    ...
    {bhvCapSwitch,                      MODEL_CAP_SWITCH,                   0}, // macro_wing_cap_switch - unused
    {bhvCapSwitch,                      MODEL_CAP_SWITCH,                   1}, // macro_metal_cap_switch - unused
    {bhvCapSwitch,                      MODEL_CAP_SWITCH,                   2}, // macro_vanish_cap_switch - unused
    {bhvCapSwitch,                      MODEL_CAP_SWITCH,                   3}, // macro_yellow_cap_switch - unused
    {bhvWaterLevelDiamond,              MODEL_BREAKABLE_BOX,                0}, // macro_water_level_breakable_box - unused
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,              0}, // macro_box_wing_cap
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,              1}, // macro_box_metal_cap
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,              2}, // macro_box_vanish_cap
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,              3}, // macro_box_koopa_shell
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,              4}, // macro_box_one_coin - unused
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,              5}, // macro_box_three_coins
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,              6}, // macro_box_ten_coins
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,              7}, // macro_box_1up
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,              8}, // macro_box_star_1
    {bhvBreakableBox,                   MODEL_BREAKABLE_BOX,                0}, // macro_breakable_box_no_coins
    {bhvBreakableBox,                   MODEL_BREAKABLE_BOX,                1}, // macro_breakable_box_three_coins
    ...
    {bhvHiddenObject,                   MODEL_BREAKABLE_BOX,                0}, // macro_hidden_box
    {bhvHiddenObject,                   MODEL_BREAKABLE_BOX,                1}, // macro_hidden_object_2 - unused
    {bhvHiddenObject,                   MODEL_BREAKABLE_BOX,                2}, // macro_hidden_object_3 - unused
    {bhvBreakableBox,                   MODEL_BREAKABLE_BOX,                3}, // macro_breakable_box_giant
    {bhvKoopaShellUnderwater,           MODEL_KOOPA_SHELL,                  0}, // macro_koopa_shell_underwater
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,              9}, // macro_box_1up_running_away
    ...
    {bhvFlyGuy,                         MODEL_FLYGUY,                       1}, // macro_fire_fly_guy
    {bhvJumpingBox,                     MODEL_BREAKABLE_BOX,                0}, // macro_jumping_box
    {bhvTripletButterfly,               MODEL_BUTTERFLY,                    0}, // macro_butterfly_triplet
    {bhvTripletButterfly,               MODEL_BUTTERFLY,                    4}, // macro_butterfly_triplet_2
    ...
    {bhvKoopa,                          MODEL_KOOPA_WITH_SHELL,             2}, // macro_bob_koopa_the_quick - unused
    {bhvKoopaRaceEndpoint,              MODEL_NONE,                         0}, // macro_koopa_race_endpoint - unused
    {bhvBobomb,                         MODEL_BLACK_BOBOMB,                 0}, // macro_bobomb
    ...
    {bhvBobomb,                         MODEL_BLACK_BOBOMB,                 1}, // macro_bobomb_still
    ...
    {bhvMontyMole,                      MODEL_MONTY_MOLE,                   0}, // macro_monty_mole_2 - unused
    {bhvMontyMole,                      MODEL_MONTY_MOLE,                   1}, // macro_monty_mole
    ...
    {bhvMrBlizzard,                     MODEL_MR_BLIZZARD_HIDDEN,           0}, // macro_mr_blizzard
    {bhvMrBlizzard,                     MODEL_MR_BLIZZARD_HIDDEN,           0}, // macro_mr_blizzard_copy - unused
    ...
    {bhvMrBlizzard,                     MODEL_MR_BLIZZARD_HIDDEN,           1}, // macro_mr_blizzard_2 - unused
    ...
    {bhvFishSpawner,                    MODEL_NONE,                         2}, // macro_fish_group_4 - unused
    {bhvFishSpawner,                    MODEL_NONE,                         3}, // macro_fish_group_2
    ...
    {bhvMacroUkiki,                     MODEL_UKIKI,                        0}, // macro_ukiki - unused
    {bhvMacroUkiki,                     MODEL_UKIKI,                        1}, // macro_ukiki_2 - unused
    ...
    {bhvKoopa,                          MODEL_KOOPA_WITH_SHELL,             1}, // macro_koopa
    {bhvKoopa,                          MODEL_KOOPA_WITHOUT_SHELL,          0}, // macro_koopa_shellless - unused
    {bhvWoodenPost,                     MODEL_WOODEN_POST,                  0}, // macro_wooden_post_copy - unused
    {bhvFirePiranhaPlant,               MODEL_PIRANHA_PLANT,                0}, // macro_fire_piranha_plant
    {bhvFirePiranhaPlant,               MODEL_PIRANHA_PLANT,                1}, // macro_fire_piranha_plant_2 - unused
    {bhvKoopa,                          MODEL_KOOPA_WITH_SHELL,             4}, // macro_thi_koopa_the_quick
    ...
    {bhvSwoop,                          MODEL_SWOOP,                        0}, // macro_swoop
    {bhvSwoop,                          MODEL_SWOOP,                        1}, // macro_swoop_2
    ...
    {bhvTTCRotatingSolid,               MODEL_TTC_ROTATING_CUBE,            0}, // macro_ttc_rotating_cube
    {bhvTTCRotatingSolid,               MODEL_TTC_ROTATING_PRISM,           1}, // macro_ttc_rotating_prism
    {bhvTTCPendulum,                    MODEL_TTC_PENDULUM,                 0}, // macro_ttc_pendulum
    {bhvTTCTreadmill,                   MODEL_TTC_LARGE_TREADMILL,          0}, // macro_ttc_large_treadmill
    {bhvTTCTreadmill,                   MODEL_TTC_SMALL_TREADMILL,          1}, // macro_ttc_small_treadmill
    {bhvTTCMovingBar,                   MODEL_TTC_PUSH_BLOCK,               0}, // macro_ttc_push_block
    {bhvTTCCog,                         MODEL_TTC_ROTATING_HEXAGON,         0}, // macro_ttc_rotating_hexagon
    {bhvTTCCog,                         MODEL_TTC_ROTATING_TRIANGLE,        2}, // macro_ttc_rotating_triangle
    {bhvTTCPitBlock,                    MODEL_TTC_PIT_BLOCK,                0}, // macro_ttc_pit_block
    {bhvTTCPitBlock,                    MODEL_TTC_PIT_BLOCK_UNUSED,         1}, // macro_ttc_pit_block_2 - unused
    {bhvTTCElevator,                    MODEL_TTC_ELEVATOR_PLATFORM,        0}, // macro_ttc_elevator_platform
    {bhvTTC2DRotator,                   MODEL_TTC_CLOCK_HAND,               0}, // macro_ttc_clock_hand
    {bhvTTCSpinner,                     MODEL_TTC_SPINNER,                  0}, // macro_ttc_spinner
    {bhvTTC2DRotator,                   MODEL_TTC_SMALL_GEAR,               1}, // macro_ttc_small_gear
    {bhvTTC2DRotator,                   MODEL_TTC_LARGE_GEAR,               1}, // macro_ttc_large_gear
    {bhvTTCTreadmill,                   MODEL_TTC_LARGE_TREADMILL,          2}, // macro_ttc_large_treadmill_2
    {bhvTTCTreadmill,                   MODEL_TTC_SMALL_TREADMILL,          3}, // macro_ttc_small_treadmill_2
    ...
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,             10}, // macro_box_star_2
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,             11}, // macro_box_star_3
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,             12}, // macro_box_star_4
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,             13}, // macro_box_star_5 - unused
    {bhvExclamationBox,                 MODEL_EXCLAMATION_BOX,             14}, // macro_box_star_6
    ...
    {bhvFloomba,                        MODEL_GOOMBA,                       0}, // macro_floomba
    {bhvFloomba,                        MODEL_GOOMBA,                       1}, // macro_huge_floomba
    {bhvFloomba,                        MODEL_GOOMBA,                       2}, // macro_tiny_floomba
