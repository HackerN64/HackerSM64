...
DECLARE_SEGMENT(segment2_yaz0)

DECLARE_SEGMENT(water_skybox_yaz0)
DECLARE_SEGMENT(ccm_skybox_yaz0)
DECLARE_SEGMENT(clouds_skybox_yaz0)
DECLARE_SEGMENT(bitfs_skybox_yaz0)
DECLARE_SEGMENT(wdw_skybox_yaz0)
DECLARE_SEGMENT(cloud_floor_skybox_yaz0)
DECLARE_SEGMENT(ssl_skybox_yaz0)
DECLARE_SEGMENT(bbh_skybox_yaz0)
DECLARE_SEGMENT(bidw_skybox_yaz0)
DECLARE_SEGMENT(bits_skybox_yaz0)

DECLARE_SEGMENT(fire_yaz0)
DECLARE_SEGMENT(spooky_yaz0)
DECLARE_SEGMENT(generic_yaz0)
DECLARE_SEGMENT(water_yaz0)
DECLARE_SEGMENT(sky_yaz0)
DECLARE_SEGMENT(snow_yaz0)
DECLARE_SEGMENT(cave_yaz0)
DECLARE_SEGMENT(machine_yaz0)
DECLARE_SEGMENT(mountain_yaz0)
DECLARE_SEGMENT(grass_yaz0)
DECLARE_SEGMENT(outside_yaz0)
DECLARE_SEGMENT(inside_yaz0)
DECLARE_SEGMENT(effect_yaz0)
DECLARE_SEGMENT(title_screen_bg_yaz0)

DECLARE_SEGMENT(debug_level_select_yaz0)

#ifdef VERSION_EU
DECLARE_SEGMENT(translation_de_yaz0)
DECLARE_SEGMENT(translation_en_yaz0)
DECLARE_SEGMENT(translation_fr_yaz0)
#endif
