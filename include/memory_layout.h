...
#if MEMORY_FRAGMENTATION_NO_FRAGMENTATION == MEMORY_FRAGMENTATION_LEVEL || MEMORY_FRAGMENTATION_ZBUFFER_AND_FRAMEBUFFERS_CONTIGUOUS == MEMORY_FRAGMENTATION_LEVEL
