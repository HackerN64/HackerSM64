...
#define OS_NSEC_TO_CYCLES(n)	(((u64)(n) * (OS_CPU_COUNTER / 15625000LL)) / (  1000000000LL / 15625000LL)) // ((n *    3) /   64)
#define OS_USEC_TO_CYCLES(n)	(((u64)(n) * (OS_CPU_COUNTER /    15625LL)) / (     1000000LL /    15625LL)) // ((n * 3000) /   64)
#define OS_CYCLES_TO_NSEC(c)	(((u64)(c) * (  1000000000LL / 15625000LL)) / (OS_CPU_COUNTER / 15625000LL)) // ((c *   64) /    3)
#define OS_CYCLES_TO_USEC(c)	(((u64)(c) * (     1000000LL /    15625LL)) / (OS_CPU_COUNTER /    15625LL)) // ((c *   64) / 3000)
