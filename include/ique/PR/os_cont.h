...
#ifndef BBC
    /*0x03*/ u8  errno;                     /* Error number */
#else
    /*0x03*/ u8  err_no;                    /* Error number */
#endif
} OSContStatus; /*0x04*/
...
#ifndef BBC
    /*0x07*/ u8   errno;                    /* Error number */
#else
    /*0x07*/ u8   err_no;                   /* Error number*/
#endif
} OSContRamIo; /*0x08*/
