...
DEFINE_DIALOG(DIALOG_005, SOUND_OBJ_KOOPA_TALK, 3, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_013, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_014, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_023, SOUND_OBJ_BOWSER_INTRO_LAUGH, 3, 95, 200, _("\
This key doesn't fit!\n\
Maybe it's for the\n\
basement..."))

DEFINE_DIALOG(DIALOG_024, SOUND_OBJ_BOWSER_INTRO_LAUGH, 5, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_030, NO_SOUND, 6, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_039, NO_SOUND, 4, 30, 200, _("\
No visitors allowed,\n\
by decree of\n\
the Big Bob-omb\n\
\n\
...
DEFINE_DIALOG(DIALOG_041, SOUND_OBJ_KOOPA_TALK, 3, 30, 200, _("\
I win! You lose!\n\
Ha ha ha!\n\
\n\
...
DEFINE_DIALOG(DIALOG_048, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_054, NO_SOUND, 5, 30, 200, _("\
Welcome to the snow\n\
...
DEFINE_DIALOG(DIALOG_055, SOUND_OBJ_BIG_PENGUIN_YELL, 4, 30, 200, _("\
Hey-ey, Mario, buddy,\n\
...
DEFINE_DIALOG(DIALOG_058, SOUND_OBJ_BIG_PENGUIN_YELL, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_059, SOUND_OBJ_BIG_PENGUIN_YELL, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_062, NO_SOUND, 3, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_063, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_064, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_070, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_071, NO_SOUND, 3, 30, 200, _("\
Danger Ahead!\n\
...
DEFINE_DIALOG(DIALOG_073, NO_SOUND, 4, 95, 200, _("\
Aarrgh! Ahoy, matey. I\n\
...
DEFINE_DIALOG(DIALOG_076, NO_SOUND, 6, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_081, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_085, SOUND_OBJ_BOO_LAUGH_LONG, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_087, NO_SOUND, 4, 30, 200, _("\
Santa Claus isn't the only\n\
one who can go down a\n\
chimney! Come on in!\n\
/--Cabin Proprietor"))

DEFINE_DIALOG(DIALOG_088, NO_SOUND, 5, 30, 200, _("\
Work Elevator\n\
...
DEFINE_DIALOG(DIALOG_089, NO_SOUND, 5, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_093, SOUND_OBJ_BOWSER_LAUGH, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_098, SOUND_OBJ_BOO_LAUGH_LONG, 2, 95, 200, _("\
Come on in here...\n\
...heh, heh, heh..."))

// unused
DEFINE_DIALOG(DIALOG_099, SOUND_OBJ_BOO_LAUGH_LONG, 5, 95, 200, _("\
Eh he he...\n\
...
DEFINE_DIALOG(DIALOG_100, SOUND_OBJ_UKIKI_CHATTER_LONG, 3, 95, 200, _("\
Ukkiki...Wakkiki...kee kee!\n\
Ha! I snagged it!\n\
It's mine! Heeheeheeee!"))

DEFINE_DIALOG(DIALOG_101, SOUND_OBJ_UKIKI_CHATTER_LONG, 3, 95, 200, _("\
Ackk! Let...go...\n\
You're...choking...me...\n\
...
DEFINE_DIALOG(DIALOG_105, SOUND_OBJ_BOBOMB_BUDDY_TALK, 3, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_108, SOUND_OBJ_BOO_LAUGH_LONG, 2, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_111, NO_SOUND, 4, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_114, SOUND_OBJ2_BOSS_DIALOG_GRUNT, 5, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_115, SOUND_OBJ2_BOSS_DIALOG_GRUNT, 5, 95, 200, _("\
No! Crushed again!\n\
...
DEFINE_DIALOG(DIALOG_116, SOUND_OBJ2_BOSS_DIALOG_GRUNT, 5, 95, 200, _("\
Whaaa....Whaaat?\n\
Can it be that a\n\
...
DEFINE_DIALOG(DIALOG_117, SOUND_OBJ2_BOSS_DIALOG_GRUNT, 1, 95, 200, _("\
Who...walk...here?\n\
Who...break...seal?\n\
Wake..ancient..ones?\n\
We no like light...\n\
...
DEFINE_DIALOG(DIALOG_121, NO_SOUND, 5, 30, 200, _("\
Nooo! It can't be!\n\
...
DEFINE_DIALOG(DIALOG_123, NO_SOUND, 4, 30, 200, _("\
Metal Cavern\n\
Right: To Waterfall\n\
...
DEFINE_DIALOG(DIALOG_130, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_131, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_132, SOUND_OBJ_BIG_PENGUIN_YELL, 4, 30, 200, _("\
Whoa, Mario, pal, you\n\
...
DEFINE_DIALOG(DIALOG_134, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_137, NO_SOUND, 6, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_138, NO_SOUND, 3, 30, 200, _("\
Down: Underground Lake\n\
Left: Black Hole\n\
Right: Hazy Maze (Closed)"))

DEFINE_DIALOG(DIALOG_139, NO_SOUND, 6, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_144, NO_SOUND, 6, 150, 200, _("\
You've recovered 30\n\
Power Stars! Now you can\n\
...
DEFINE_DIALOG(DIALOG_147, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_149, NO_SOUND, 3, 30, 200, _("\
Welcome to\n\
Princess Toadstool's\n\
secret slide!\n\
...
DEFINE_DIALOG(DIALOG_151, SOUND_OBJ_WIGGLER_TALK, 4, 30, 200, _("\
I can't take this\n\
...
DEFINE_DIALOG(DIALOG_152, SOUND_OBJ_WIGGLER_TALK, 3, 30, 200, _("\
Owwch! Uncle! Uncle!\n\
...
DEFINE_DIALOG(DIALOG_155, NO_SOUND, 6, 30, 200, _("\
Thanks to the power of\n\
the Stars, life is\n\
returning to the castle.\n\
Please, Mario, you have\n\
...
DEFINE_DIALOG(DIALOG_156, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_165, NO_SOUND, 5, 30, 200, _("\
