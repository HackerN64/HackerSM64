...
DEFINE_DIALOG(DIALOG_000, NO_SOUND, 6, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_002, SOUND_OBJ_BOBOMB_BUDDY_TALK, 4, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_003, SOUND_OBJ_BOBOMB_BUDDY_TALK, 5, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_004, SOUND_OBJ_BOBOMB_BUDDY_TALK, 3, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_005, SOUND_OBJ_KOOPA_TALK, 4, 30, 200, _("\
Hey Mario! Stimmt es,\n\
...
DEFINE_DIALOG(DIALOG_006, SOUND_OBJ_KOOPA_TALK, 3, 30, 200, _("\
Hey!!! Willst Du mich\n\
auf den Arm nehmen?\n\
Abkürzen gilt nicht!\n\
...
DEFINE_DIALOG(DIALOG_007, SOUND_OBJ_KOOPA_TALK, 5, 30, 200, _("\
Hmmmmpff...pffff...hach!\n\
Boah! Du...hast...mich...\n\
...
DEFINE_DIALOG(DIALOG_009, SOUND_OBJ_KOOPA_TALK, 5, 30, 200, _("\
Lang, lang ist's her!\n\
 ...
 */
DEFINE_DIALOG(DIALOG_010, SEQ_EVENT_SOLVE_PUZZLE, 4, 30, 200, _("\
Du hast den roten\n\
Schalter aktiviert.\n\
...
DEFINE_DIALOG(DIALOG_011, SEQ_EVENT_SOLVE_PUZZLE, 4, 30, 200, _("\
Du hast den grünen\n\
Schalter aktiviert.\n\
Ab jetzt kannst Du die\n\
...
DEFINE_DIALOG(DIALOG_012, SEQ_EVENT_SOLVE_PUZZLE, 4, 30, 200, _("\
Du hast den blauen\n\
Schalter aktiviert.\n\
Ab jetzt kannst Du die\n\
Tarnkappe einsetzen\n\
...
DEFINE_DIALOG(DIALOG_013, NO_SOUND, 6, 30, 200, _("\
Du hast 100 Münzen\n\
eingesammelt. Der\n\
Stern verleiht Dir\n\
zusätzliche Kraft.\n\
...
DEFINE_DIALOG(DIALOG_014, NO_SOUND, 6, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_017, SOUND_OBJ_KING_BOBOMB_TALK, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_018, NO_SOUND, 4, 30, 200, _("\
Schlafende Gefahren\n\
sollte man nicht wecken.\n\
Die schleichende Weisheit\n\
verleiht längeres Leben!"))

DEFINE_DIALOG(DIALOG_019, NO_SOUND, 2, 30, 200, _("\
Vorsicht, die Fliesen\n\
sind frisch gebohnert!"))

DEFINE_DIALOG(DIALOG_020, NO_SOUND, 6, 95, 150, _("\
Lieber Mario!\n\
...
DEFINE_DIALOG(DIALOG_021, SOUND_OBJ_BOWSER_INTRO_LAUGH, 5, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_022, SOUND_OBJ_BOWSER_INTRO_LAUGH, 3, 95, 200, _("\
Ohne den passenden\n\
Schlüssel bleibt Dir\n\
dieser Weg versperrt!"))

DEFINE_DIALOG(DIALOG_023, SOUND_OBJ_BOWSER_INTRO_LAUGH, 2, 95, 200, _("\
Der Kellerschlüssel wird\n\
Dir hier nichts nützen!"))

DEFINE_DIALOG(DIALOG_024, SOUND_OBJ_BOWSER_INTRO_LAUGH, 4, 95, 200, _("\
Du brauchst schon einen\n\
Stern, um diese Tür zu\n\
öffnen. Untersuche doch\n\
einmal die Wandgemälde!"))

DEFINE_DIALOG(DIALOG_025, SOUND_OBJ_BOWSER_INTRO_LAUGH, 4, 95, 200, _("\
Zum Öffnen dieser Tür\n\
benötigst Du drei Sterne.\n\
Du mußt also noch [%]\n\
von ihnen finden!"))

DEFINE_DIALOG(DIALOG_026, SOUND_OBJ_BOWSER_INTRO_LAUGH, 4, 95, 200, _("\
Zum Öffnen dieser Tür\n\
benötigst Du acht Sterne.\n\
Du mußt also noch [%]\n\
von ihnen finden!"))

DEFINE_DIALOG(DIALOG_027, SOUND_OBJ_BOWSER_INTRO_LAUGH, 4, 95, 200, _("\
Zum Öffnen dieser Tür\n\
benötigst Du 30 Sterne.\n\
Du mußt also noch [%]\n\
von ihnen finden."))

DEFINE_DIALOG(DIALOG_028, SOUND_OBJ_BOWSER_INTRO_LAUGH, 4, 95, 200, _("\
Zum Öffnen dieser Tür\n\
...
DEFINE_DIALOG(DIALOG_030, NO_SOUND, 4, 30, 200, _("\
Die Lakitu-Film AG\n\
...
DEFINE_DIALOG(DIALOG_031, NO_SOUND, 3, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_032, NO_SOUND, 5, 30, 200, _("\
Mit der Federkappe\n\
kannst Du fliegen.\n\
...
DEFINE_DIALOG(DIALOG_034, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_038, NO_SOUND, 2, 95, 200, _("\
Die mystische Kraft der\n\
Sterne öffnet die Tür!"))

DEFINE_DIALOG(DIALOG_039, NO_SOUND, 5, 30, 200, _("\
Besuchern ist das\n\
...
DEFINE_DIALOG(DIALOG_040, NO_SOUND, 3, 30, 200, _("\
Vorsicht, Brücke zerstört!\n\
Überquere das Eistal in\n\
der Gondel."))

DEFINE_DIALOG(DIALOG_041, SOUND_OBJ_KOOPA_TALK, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_042, NO_SOUND, 4, 30, 200, _("\
Achtung!\n\
...
DEFINE_DIALOG(DIALOG_044, NO_SOUND, 5, 95, 200, _("\
Uh...oh...gääähn...\n\
...
DEFINE_DIALOG(DIALOG_045, NO_SOUND, 6, 95, 200, _("\
Hey, Mann, Mario! Mir\n\
geht die Puste aus.\n\
Du ißt zuviel Pasta!\n\
...
DEFINE_DIALOG(DIALOG_046, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_047, SOUND_OBJ_BOBOMB_BUDDY_TALK, 3, 95, 200, _("\
Hallo!\n\
Ich mache die Kanone\n\
zum Abschuß bereit!"))

DEFINE_DIALOG(DIALOG_048, NO_SOUND, 6, 30, 200, _("\
An einigen Stellen\n\
herrscht extreme\n\
Rutschgefahr! Sieh\n\
am besten zuerst im\n\
...
DEFINE_DIALOG(DIALOG_049, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_051, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_053, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_054, NO_SOUND, 6, 30, 200, _("\
Herzlich willkommen\n\
...
DEFINE_DIALOG(DIALOG_055, SOUND_OBJ_BIG_PENGUIN_YELL, 5, 30, 200, _("\
Hihi, hallo Mario!\n\
Du siehst aus, als\n\
...
DEFINE_DIALOG(DIALOG_056, SOUND_OBJ_BIG_PENGUIN_YELL, 6, 30, 200, _("\
Du...Du...ha...hast\n\
...
DEFINE_DIALOG(DIALOG_057, SOUND_OBJ_BIG_PENGUIN_YELL, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_058, SOUND_OBJ_BIG_PENGUIN_YELL, 5, 30, 200, _("\
Das ist doch...\n\
...
DEFINE_DIALOG(DIALOG_059, SOUND_OBJ_BIG_PENGUIN_YELL, 6, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_060, NO_SOUND, 4, 30, 200, _("\
Achtung, Achtung!\n\
...
DEFINE_DIALOG(DIALOG_061, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_062, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_063, NO_SOUND, 3, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_064, NO_SOUND, 3, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_066, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_067, SOUND_OBJ_BOWSER_LAUGH, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_068, NO_SOUND, 5, 30, 200, _("\
Du bist im Land des\n\
...
DEFINE_DIALOG(DIALOG_069, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_070, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_071, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_072, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_073, NO_SOUND, 5, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_074, NO_SOUND, 5, 30, 200, _("\
Siehst Du den Block\n\
...
DEFINE_DIALOG(DIALOG_076, NO_SOUND, 4, 30, 200, _("\
Hallo Mario! Du hast\n\
bereits einiges zur\n\
...
DEFINE_DIALOG(DIALOG_077, NO_SOUND, 4, 150, 200, _("\
...
DEFINE_DIALOG(DIALOG_079, SOUND_OBJ_UKIKI_CHATTER_LONG, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_080, SOUND_OBJ_UKIKI_CHATTER_LONG, 3, 30, 200, _("\
Hey Baby, komm schon!\n\
Wo bleibst Du denn so\n\
lange?"))

DEFINE_DIALOG(DIALOG_081, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_082, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_083, NO_SOUND, 6, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_084, NO_SOUND, 5, 30, 200, _("\
Hey, Du Rüpel, ich\n\
...
DEFINE_DIALOG(DIALOG_090, SOUND_OBJ_BOWSER_LAUGH, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_091, NO_SOUND, 3, 30, 200, _("\
Achtung, starke Böen!\n\
Aber es könnte auch eine\n\
aufregende Reise werden!"))

DEFINE_DIALOG(DIALOG_092, SOUND_OBJ_BOWSER_LAUGH, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_093, SOUND_OBJ_BOWSER_LAUGH, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_096, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_097, NO_SOUND, 6, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_098, SOUND_OBJ_BOO_LAUGH_LONG, 1, 95, 200, _("\
Komm nur näher, hehehe!"))

DEFINE_DIALOG(DIALOG_099, SOUND_OBJ_BOO_LAUGH_LONG, 3, 95, 200, _("\
"))

DEFINE_DIALOG(DIALOG_100, SOUND_OBJ_UKIKI_CHATTER_LONG, 2, 95, 200, _("\
Jippiiiiieee, ich hab' sie!\n\
Jetzt gehört sie mir!!!"))

DEFINE_DIALOG(DIALOG_101, SOUND_OBJ_UKIKI_CHATTER_LONG, 5, 95, 200, _("\
Hgggnnnhhh! Laß...mich...\n\
los!!! Diese Mütze? Na\n\
...
DEFINE_DIALOG(DIALOG_102, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_103, NO_SOUND, 4, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_105, SOUND_OBJ_BOBOMB_BUDDY_TALK, 5, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_106, SOUND_OBJ_BOBOMB_BUDDY_TALK, 2, 95, 200, _("\
Bist Du bereit? Dann rein\n\
mit Dir in die Kanone!"))

DEFINE_DIALOG(DIALOG_107, SOUND_OBJ_BOO_LAUGH_LONG, 4, 95, 200, _("\
Das werde ich meinem\n\
großen Bruder erzählen!\n\
Dann kannst Du aber was\n\
erleben..."))

DEFINE_DIALOG(DIALOG_108, SOUND_OBJ_BOO_LAUGH_LONG, 6, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_109, NO_SOUND, 4, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_110, NO_SOUND, 5, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_111, NO_SOUND, 3, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_112, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_113, NO_SOUND, 6, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_114, SOUND_OBJ2_BOSS_DIALOG_GRUNT, 4, 95, 200, _("\
...
DEFINE_DIALOG(DIALOG_115, SOUND_OBJ2_BOSS_DIALOG_GRUNT, 4, 95, 200, _("\
Unglaublich! Du hast mich\n\
von meinen Kreuzschmerzen\n\
befreit! Als Dank gebe\n\
ich Dir diesen Stern!"))

DEFINE_DIALOG(DIALOG_116, SOUND_OBJ2_BOSS_DIALOG_GRUNT, 4, 95, 200, _("\
Waaaaa...wie? Du hast\n\
mich besiegt...\n\
...
DEFINE_DIALOG(DIALOG_117, SOUND_OBJ2_BOSS_DIALOG_GRUNT, 4, 95, 200, _("\
Schritte? Grabräuber?\n\
...
DEFINE_DIALOG(DIALOG_118, SOUND_OBJ2_BOSS_DIALOG_GRUNT, 6, 95, 200, _("\
Wir sind besiegt...\n\
...
DEFINE_DIALOG(DIALOG_119, NO_SOUND, 6, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_120, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_121, NO_SOUND, 6, 30, 200, _("\
Aaaaaarrrgghh!\n\
Du...hast...gewonnen!\n\
...
DEFINE_DIALOG(DIALOG_122, NO_SOUND, 4, 30, 200, _("\
Das Schwarze Loch\n\
Rechts: Arbeitsplattform\n\
////Nebellabyrinth\n\
Links:/Höhlensee"))

DEFINE_DIALOG(DIALOG_123, NO_SOUND, 3, 30, 200, _("\
Titanenhöhle\n\
Rechts: Wasserfall\n\
Links:/Grüner Schalter"))

DEFINE_DIALOG(DIALOG_124, NO_SOUND, 5, 30, 200, _("\
Arbeitsplattform\n\
Zur Beachtung:\n\
Aktiviere einen der\n\
...
DEFINE_DIALOG(DIALOG_125, NO_SOUND, 3, 30, 200, _("\
Rechts ist der Ausgang\n\
des Nebellabyrinths. Bitte\n\
Eingang links benutzen!"))

DEFINE_DIALOG(DIALOG_126, NO_SOUND, 3, 30, 200, _("\
Oben:/ Schwarzes Loch\n\
Rechts: Arbeitsplattform\n\
////Nebellabyrinth"))

DEFINE_DIALOG(DIALOG_127, NO_SOUND, 4, 30, 200, _("\
Höhlensee\n\
Rechts: Titanenhöhle\n\
...
DEFINE_DIALOG(DIALOG_128, SOUND_OBJ_KING_BOBOMB_TALK, 4, 95, 200, _("\
Hey, es ist gegen die\n\
königlichen Regeln, den\n\
Herrscher aus dem Ring\n\
zu werfen!"))

DEFINE_DIALOG(DIALOG_129, NO_SOUND, 4, 30, 200, _("\
Herzlich willkommen!\n\
...
DEFINE_DIALOG(DIALOG_130, NO_SOUND, 4, 30, 200, _("\
Herzlich willkommen!\n\
In diesem Kurs kannst\n\
...
DEFINE_DIALOG(DIALOG_131, NO_SOUND, 4, 30, 200, _("\
Herzlich willkommen!\n\
In diesem Kurs kannst\n\
...
DEFINE_DIALOG(DIALOG_132, SOUND_OBJ_BIG_PENGUIN_YELL, 3, 30, 200, _("\
Tsetsetse...Mario!\n\
...
DEFINE_DIALOG(DIALOG_133, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_134, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_135, NO_SOUND, 5, 30, 200, _("\
Bowser hat sich die\n\
...
DEFINE_DIALOG(DIALOG_136, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_137, NO_SOUND, 5, 30, 200, _("\
Vielen Dank! Du hast\n\
...
DEFINE_DIALOG(DIALOG_138, NO_SOUND, 4, 30, 200, _("\
Unten:/Höhlensee\n\
Links:/Schwarzes Loch\n\
Rechts: Nebellabyrinth\n\
////(Geschlossen!!!)"))

DEFINE_DIALOG(DIALOG_139, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_140, NO_SOUND, 6, 30, 200, _("\
Arbeitsplattform\n\
Rechts: Nebellabyrinth\n\
////Eingang\n\
Links:/Schwarzes Loch\n\
...
DEFINE_DIALOG(DIALOG_141, NO_SOUND, 5, 150, 200, _("\
Du hast einen der\n\
...
DEFINE_DIALOG(DIALOG_142, NO_SOUND, 5, 150, 200, _("\
...
DEFINE_DIALOG(DIALOG_143, NO_SOUND, 6, 150, 200, _("\
Du hast acht Sterne\n\
...
DEFINE_DIALOG(DIALOG_145, NO_SOUND, 4, 150, 200, _("\
...
DEFINE_DIALOG(DIALOG_146, NO_SOUND, 6, 150, 200, _("\
...
DEFINE_DIALOG(DIALOG_147, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_148, NO_SOUND, 4, 30, 200, _("\
Achtung, Achtung!\n\
...
DEFINE_DIALOG(DIALOG_149, NO_SOUND 5, 30, 200, _("\
Willkommen auf der\n\
...
DEFINE_DIALOG(DIALOG_150, SOUND_OBJ_WIGGLER_TALK, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_151, SOUND_OBJ_WIGGLER_TALK, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_152, SOUND_OBJ_WIGGLER_TALK, 4, 30, 200, _("\
Ooooh, halt, halt! Ich\n\
gebe auf. Hier, nimm\n\
...
DEFINE_DIALOG(DIALOG_153, NO_SOUND, 4, 30, 200, _("\
Hey, wer ist da? Wer\n\
...
DEFINE_DIALOG(DIALOG_154, NO_SOUND, 6, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_155, NO_SOUND, 3, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_156, NO_SOUND, 4, 30, 200, _("\
Diese Uhr ist wirklich\n\
ungewöhnlich. Ihr Inneres\n\
verändert sich im Laufe\n\
der Zeit."))

DEFINE_DIALOG(DIALOG_157, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_158, NO_SOUND, 6, 30, 200, _("\
Mit dem richtigen Timing\n\
kannst Du sehr hoch\n\
...
DEFINE_DIALOG(DIALOG_161, SOUND_GENERAL_YOSHI_TALK, 5, 30, 200, _("\
Hey... Mario!!! Seit\n\
...
DEFINE_DIALOG(DIALOG_162, NO_SOUND, 4, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_163, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_164, NO_SOUND, 6, 30, 200, _("\
Hi! Wie geht's, Mario?\n\
...
DEFINE_DIALOG(DIALOG_165, NO_SOUND, 4, 30, 200, _("\
Sei vorsichtig, wenn Du\n\
um den Pfahl herumrennst,\n\
damit Dir nicht schlecht\n\
wird!"))

DEFINE_DIALOG(DIALOG_166, NO_SOUND, 5, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_167, NO_SOUND, 4, 30, 200, _("\
Dort vorne ist das\n\
...
DEFINE_DIALOG(DIALOG_168, SOUND_OBJ_WIGGLER_TALK, 4, 30, 200, _("\
Bist Du immer noch hier?\n\
Findest Du nicht, daß\n\
Du bereits genug Schaden\n\
angerichtet hast?"))

DEFINE_DIALOG(DIALOG_169, NO_SOUND, 4, 30, 200, _("\
